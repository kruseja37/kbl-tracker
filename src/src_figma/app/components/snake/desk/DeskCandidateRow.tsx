...
export function DeskCandidateRow(props: {
  ...
  return (
    <button
      ...
      className={`grid min-h-12 w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-2 px-2 py-1 text-left ${props.selected ? 'border-[var(--ballpark-brass)] bg-[var(--ballpark-action-green)]' : 'border-[var(--ballpark-panel-border)] bg-[var(--ballpark-well)]'}`}
