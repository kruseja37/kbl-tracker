...
export function WhatIfSandbox(props: {
  ...
  return (
    <div className="border-4 border-[var(--ballpark-panel-border)] p-3">
      ...
      <p className="mb-3 text-sm">Choose one change. The desk reports the money. You decide.</p>
      {!props.whatIf ? (
        <div className="flex flex-wrap gap-2">
          ...
          <select aria-label="What-if player" value={playerId} onChange={(event) => setPlayerId(event.target.value)}>
