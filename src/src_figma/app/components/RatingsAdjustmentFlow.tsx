...
export function RatingsAdjustmentFlow({ seasonId, franchiseId, onClose }: RatingsAdjustmentFlowProps) {
  ...
  const { saveRatingChanges } = useOffseasonState(seasonId, seasonNumber, { franchiseId });
  ...
  }, [ALL_PLAYERS, TEAMS, franchiseId, saveRatingChanges, onClose]);
  ...
  return (
    <div className="fixed inset-0 bg-black/95 z-50 overflow-y-auto">
      <div className="min-h-screen p-4">
        ...
        {blockedMessage && (
          <div className="max-w-6xl mx-auto mb-4 bg-[#7A341F] border-[4px] border-[#C4A853] p-4 text-sm text-[#E8E8D8]">
            {blockedMessage}
          </div>
        )}
