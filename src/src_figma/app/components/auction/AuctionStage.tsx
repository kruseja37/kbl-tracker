...
export function AuctionStage({ vm, onSelectPreset, onBid, onPass }: AuctionStageProps) {
    ...
    <div className="auc-root">
      <div className="wrap">
        <div className="statusbar">
          ...
          <span className="now">
            <span className="live" /> Now: <span className="gold">{vm.status.nowText}</span>
          </span>
        </div>
        ...
        <div className="stage">
          ...
          <div>
              ...
              {vm.overlay === "gone" && (
                <div className="stamp gone">
                  <div>
                    ...
                    <div className="note">Nobody bid. He's off the board for good — that's the cost of sitting out.</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="move">
              ...
              {isCpuTurn ? (
                <div className="cpu-wait">{vm.move.cpuTurnName} is deciding…</div>
              ) : (
                <>
                  ...
                  <div className="actions">
                    <button type="button" className="bid" disabled={!vm.move.canBid} onClick={() => onBid?.()}>
                      BID {moneyK(vm.move.currentBid)}
                    </button>
                    <button type="button" className="letgo" onClick={() => onPass?.()}>Let him go</button>
                  </div>
                </>
              )}
        ...
        {vm.coach && coachOpen && (
          <div className="coach">
            ...
            <button type="button" className="x" aria-label="Dismiss coach" onClick={() => setCoachOpen(false)}>×</button>
          </div>
        )}
      </div>
    </div>
