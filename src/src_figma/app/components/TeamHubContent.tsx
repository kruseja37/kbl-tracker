...
export function TeamHubContent() {
  ...
  if (isLoading) {
    return (
      <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-6 flex items-center justify-center min-h-[300px]">
        <div className="text-[var(--franchise-text)] text-xl">Loading team hub data...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {/* Team Hub Tabs */}
      <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] overflow-x-auto">
        <div className="flex">
          {[
            ...
            <button
              ...
              className={`flex-1 px-3 py-2 text-[9px] whitespace-nowrap transition border-r-2 border-[var(--franchise-border)] last:border-r-0 ${
                activeHubTab === tab.id
      ...
      {activeHubTab === "team" && (
        <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-6">
          <div className="text-center mb-6">
            <div
              className="text-[14px] text-[var(--franchise-text)] mb-2"
              style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}
            >
              SELECT A TEAM
            </div>
            <div className="text-[8px] text-[var(--franchise-text)]/70">Choose a team to view detailed information</div>
          </div>
            ...
            {teams.map((team) => (
              <button
                ...
                className={`p-4 transition border-[3px] ${
                  selectedTeam === team
                    ? "bg-[var(--franchise-border)] border-[var(--franchise-text)] text-[var(--franchise-text)]"
                    : "bg-[var(--franchise-panel)] border-[var(--franchise-border)] text-[var(--franchise-text)]/70 hover:bg-[var(--franchise-field-raised)]"
                }`}
              >
          ...
          {selectedTeam && (
            <>
              <div className="mt-6 p-4 bg-[var(--franchise-border)] border-[3px] border-[var(--franchise-panel-dark)] max-w-2xl mx-auto">
                <div className="text-[10px] text-[var(--franchise-text)] text-center">
                  Currently viewing: <span className="font-bold">{selectedTeam}</span>
                </div>
                <div className="text-[8px] text-[var(--franchise-text)]/60 text-center mt-1">
              ...
              <section
                ...
                className="mt-3 max-w-5xl mx-auto border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-3"
              >
                <div className="text-[9px] font-bold text-[var(--franchise-gold-soft)]">TEAM DESIGNATIONS</div>
                <div className="mt-2 grid grid-cols-2 gap-2 md:grid-cols-3 xl:grid-cols-6">
                  {teamDesignationStripSlots.map((slot) => (
                    <div key={slot.key} className="min-h-[92px] border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-2">
                      <div className="text-[7px] font-bold uppercase text-[var(--franchise-text)]/60">{slot.title}</div>
                      {slot.playerName ? (
                        <>
                        ...
                        <>
                          <div className="mt-2 text-[9px] font-bold text-[var(--franchise-text)]/45">— none</div>
                          <div className="mt-2 text-[7px] text-[var(--franchise-text)]/50">{slot.stateLabel}</div>
                        </>
                      )}
                    </div>
                  ))}
                </div>
                <div className="mt-2 text-[7px] text-[var(--franchise-text)]/60">
        ...
        <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-4">
          ...
          >
            ...
            <div className="grid gap-3 lg:grid-cols-[minmax(0,2fr)_minmax(220px,1fr)]">
              ...
              <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
                <div className="mb-2 text-[8px] font-bold text-[var(--franchise-gold)]">STARTING ROTATION</div>
                    ...
                    {manualRotationIds.map((playerId, index) => {
                      ...
                      return (
                        <div key={`${playerId}-${index}`} className="grid grid-cols-[28px_minmax(120px,1fr)_70px] items-center gap-2 text-[8px]">
                          <div className="text-[var(--franchise-text)]/70">#{index + 1}</div>
                          <div className="text-[var(--franchise-text)]">
          ...
          <div className="mb-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-3">
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
              <div>
                <div className="text-[10px] text-[var(--franchise-gold)]">OPTIMAL LINEUP BENCHMARKS</div>
                <div className="mt-1 text-[8px] text-[var(--franchise-text)]/60">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`border-2 px-3 py-1 text-[8px] font-bold ${
                    lineupMode === "DH"
                      ? "border-[var(--franchise-text)] bg-[var(--franchise-border)] text-[var(--franchise-text)]"
                      : "border-[var(--franchise-border)] bg-[var(--franchise-header)] text-[var(--franchise-text)]/70"
                  }`}
                >
                  DH
                </button>
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {(["R", "L"] as OpposingPitcherHand[]).map((hand) => {
                ...
                return (
                  <div key={hand} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
                    <div className="mb-2 flex items-center justify-between gap-2">
                      <span className="text-[8px] font-bold text-[var(--franchise-gold)]">VS {hand}HP</span>
                      <span className="text-[7px] text-[var(--franchise-text)]/60">
                    ...
                    <div className="grid grid-cols-4 gap-1">
                      <button
                        ...
                        className="border-2 border-[var(--franchise-text)]/30 bg-[var(--franchise-panel)] px-1 py-1 text-[7px] hover:border-[var(--franchise-gold)] disabled:opacity-40"
                      >
                        COMPARE
                      </button>
                      <button
          ...
          <div className="overflow-x-auto">
            <table aria-label="Franchise roster scan table" className="w-full min-w-[760px] text-[10px]">
              <thead>
                <tr className="border-b-2 border-[var(--franchise-border)]">
                  <th className="text-left py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("name")}>
                    NAME {rosterSortColumn === "name" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("position")}>
                    POS {rosterSortColumn === "position" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("rosterStatus")}>
                    STATUS {rosterSortColumn === "rosterStatus" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-right py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("salary")}>
                    SALARY {rosterSortColumn === "salary" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("morale")}>
                    MORALE {rosterSortColumn === "morale" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-left py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("stat")}>
                    STATS {rosterSortColumn === "stat" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-left py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleRosterSort("designation")}>
                    DESIGNATION {rosterSortColumn === "designation" && (rosterSortDirection === "asc" ? "↑" : "↓")}
                  </th>
                  <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70">PROFILE</th>
                </tr>
              </thead>
              <tbody>
                {getSortedRoster().map((player, idx) => (
                  <tr key={player.playerId ?? idx} className={`border-b border-[var(--franchise-border)]/30 ${idx % 2 === 0 ? 'bg-[var(--franchise-panel)]/20' : ''}`}>
                    <td className="py-2 px-2 text-[var(--franchise-text)]">
                      <button
                        type="button"
                        disabled={!player.playerId}
                        onClick={() => player.playerId && setSelectedProfilePlayerId(player.playerId)}
                        className="text-left font-bold text-[var(--franchise-text)] hover:text-[var(--franchise-gold)] disabled:cursor-not-allowed disabled:opacity-60"
                      >
                        {player.name}
                      </button>
                    </td>
                    <td className="py-2 px-2 text-[var(--franchise-text)] text-center">{player.position}</td>
                    <td className="py-2 px-2 text-[var(--franchise-text)] text-center">
                      <div className="font-bold">{player.rosterStatus}</div>
                      <div className="text-[8px] text-[var(--franchise-text)]/55">{player.teamContext || '—'}</div>
                    </td>
                    <td className="py-2 px-2 text-[var(--franchise-text)] text-right">{player.contract}</td>
                    <td className="py-2 px-2 text-center">
                      <span className={typeof player.morale === 'number' ? (player.morale >= 70 ? "text-[var(--franchise-win)]" : player.morale <= 35 ? "text-[var(--franchise-loss)]" : "text-[var(--franchise-text)]") : "text-[var(--franchise-text)]/50"}>
                        {player.morale}
                      </span>
                      <div className="text-[8px] text-[var(--franchise-text)]/55">{player.moraleState}</div>
                    </td>
                    ...
                    <td className="py-2 px-2 text-center">
                      <button
                        ...
                        onClick={() => player.playerId && setSelectedProfilePlayerId(player.playerId)}
                        className="p-1 hover:bg-[var(--franchise-border)] disabled:opacity-40 disabled:cursor-not-allowed"
                      >
                        <User className="w-3 h-3 text-[var(--franchise-text)]" />
                      </button>
                    </td>
                  </tr>
                ))}
        ...
        <div className="space-y-4">
              ...
              <button
                ...
                className={`flex-1 py-2 px-3 text-[9px] transition ${
                  statsView === "spraychart"
                    ? "bg-[var(--franchise-border)] text-[var(--franchise-text)]"
                    : "bg-[var(--franchise-panel)] text-[var(--franchise-text)]/40 cursor-not-allowed"
                }`}
              >
            ...
            <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[9px]">
                  <thead>
                    <tr className="border-b-2 border-[var(--franchise-border)]">
                      <th className="text-left py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleStatsSort("name")}>
                        NAME {statsSortColumn === "name" && (statsSortDirection === "asc" ? "↑" : "↓")}
                      </th>
                      <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70">POS</th>
                      <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleStatsSort("war")}>
                        WAR {statsSortColumn === "war" && (statsSortDirection === "asc" ? "↑" : "↓")}
                      </th>
                      <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleStatsSort("pwar")}>
                        pWAR {statsSortColumn === "pwar" && (statsSortDirection === "asc" ? "↑" : "↓")}
                      </th>
                      <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleStatsSort("bwar")}>
                        bWAR {statsSortColumn === "bwar" && (statsSortDirection === "asc" ? "↑" : "↓")}
                      </th>
                      <th className="text-center py-2 px-2 text-[var(--franchise-text)]/70 cursor-pointer hover:text-[var(--franchise-text)]" onClick={() => handleStatsSort("rwar")}>
                  ...
                  <tbody>
                    {getSortedStats().map((player, idx) => (
                      <tr key={idx} className={`border-b border-[var(--franchise-border)]/30 ${idx % 2 === 0 ? 'bg-[var(--franchise-panel)]/20' : ''}`}>
                        <td className="py-2 px-2 text-[var(--franchise-text)]">{player.name}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)] text-center">{player.pos}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)] text-center font-bold">{player.war.toFixed(1)}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)] text-center">{player.pwar.toFixed(1)}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)] text-center">{player.bwar.toFixed(1)}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)] text-center">{player.rwar.toFixed(1)}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)] text-center">{player.fwar.toFixed(1)}</td>
                        <td className="py-2 px-2 text-[var(--franchise-text)]/50 text-center text-[8px]">
          ...
          {statsView === "spraychart" && (
            <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-8 text-center">
              <div className="text-[12px] text-[var(--franchise-text)]/50 mb-2">ROW EVIDENCE INSPECTOR AVAILABLE IN STADIUM TAB</div>
              <div className="text-[10px] text-[var(--franchise-text)]/40">
      ...
      {activeHubTab === "manager" && (
        <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-8">
          <div className="text-center">
            <User className="w-8 h-8 text-[var(--franchise-text)]/30 mx-auto mb-4" />
            <div className="text-[12px] text-[var(--franchise-text)]/50 mb-2">MANAGER</div>
            <div className="text-[10px] text-[var(--franchise-text)]/40">
...
function FranchiseProfileField({ label, value }: { label: string; value: unknown }) {
  return (
    <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
      <div className="text-[7px] font-bold text-[var(--franchise-gold)]">{label}</div>
      <div className="mt-1 text-[9px] text-[var(--franchise-text)]">{formatProfileValue(value)}</div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <div className="text-[10px] font-bold text-[var(--franchise-gold)]">{title}</div>
      ...
      <div className="mt-3 grid gap-2 md:grid-cols-[140px_1fr_auto]">
        <label className="block border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
          <span className="block text-[9px] font-bold text-[var(--franchise-gold)]">{deltaLabel}</span>
          <input
            ...
            className="mt-1 w-full border-2 border-[var(--franchise-panel-dark)] bg-[var(--franchise-panel)] p-1 text-[10px] text-[var(--franchise-text)]"
          />
        </label>
        <label className="block border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
          <span className="block text-[9px] font-bold text-[var(--franchise-gold)]">{reasonLabel}</span>
          <input
        ...
        <button
          ...
          className="border-2 border-[var(--franchise-gold)] bg-[var(--franchise-header)] px-3 py-2 text-[10px] font-bold text-[var(--franchise-text)] hover:bg-[var(--franchise-panel)] disabled:cursor-not-allowed disabled:opacity-40"
        >
          {pending ? 'APPLYING...' : 'APPLY'}
        </button>
      </div>
      <div className="mt-2 text-[10px] leading-snug text-[var(--franchise-text)]/60">
        Target: {targetLabel}. Delta must be a non-zero whole number; storage clamps the final value to 0-99.
      </div>
      {message && (
        <div className="mt-2 border-2 border-[var(--franchise-win-text)]/40 bg-[var(--franchise-border)] p-2 text-[10px] text-[var(--franchise-win-text)]">
          {message}
        </div>
      )}
      {error && (
        <div className="mt-2 border-2 border-[var(--franchise-loss)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[10px] text-[var(--franchise-loss-text)]">
          {error}
        </div>
      )}
    </section>
...
function FranchiseProfileEditHistoryPanel({
  ...
  return (
    <section className="mt-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-3">
      <div className="text-[9px] font-bold text-[var(--franchise-gold)]">PROFILE EDIT HISTORY</div>
      ...
      {entries.length === 0 ? (
        <div className="mt-3 border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[8px] text-[var(--franchise-text)]/65">
        ...
        <div className="mt-3 space-y-2">
          {entries.map((entry, index) => (
            <div
              ...
              className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[8px] text-[var(--franchise-text)]"
            >
              <div className="flex flex-wrap items-center justify-between gap-2">
                <span className="font-bold text-[var(--franchise-gold)]">{entry.field}</span>
                <span className="text-[var(--franchise-text)]/55">{formatProfileHistoryDate(entry.date)}</span>
              </div>
              <div className="mt-1 text-[var(--franchise-text)]/75">
...
function FranchisePlayerMoraleHistoryPanel({
  ...
  return (
    <section
      className="mt-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-3"
      aria-label="Player morale spec alignment"
    >
      <div className="text-[9px] font-bold text-[var(--franchise-gold)]">PLAYER MORALE HISTORY</div>
      <div className="mt-1 text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      <div className="mt-3 grid gap-2 md:grid-cols-3">
        ...
        <div className="border-2 border-[var(--franchise-loss-panel)] bg-[var(--franchise-loss-panel)] p-2 text-[10px] leading-snug text-[var(--franchise-loss-text)]">
      ...
      {view.lastEvent ? (
        <div className="mt-3 border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[10px] leading-snug text-[var(--franchise-text)]/70">
          Last event: {view.lastEvent.reason}
        </div>
      ) : (
        <div className="mt-3 border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      {view.recentHistory.length > 0 && (
        <div className="mt-3 space-y-2">
          {view.recentHistory.map((entry) => (
            <div key={entry.id ?? `${entry.sourceEventId}-${entry.timestamp}`} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[10px] text-[var(--franchise-text)]">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <span className="font-bold text-[var(--franchise-gold)]">
                  {entry.previousValue} → {entry.currentValue} ({(entry.delta ?? 0) > 0 ? '+' : ''}{entry.delta ?? 0})
                </span>
                <span className="text-[var(--franchise-text)]/55">{formatProfileHistoryDate(entry.timestamp)}</span>
              </div>
              <div className="mt-1 text-[var(--franchise-text)]/75">{entry.reason}</div>
              <div className="mt-1 text-[var(--franchise-text)]/55">Source: {entry.sourceKind ?? 'unknown'}</div>
            </div>
          ))}
        </div>
      )}
      ...
      {canAdjust ? (
        ...
        <div className="mt-3 border-2 border-[var(--franchise-loss-panel)] bg-[var(--franchise-loss-panel)] p-2 text-[10px] leading-snug text-[var(--franchise-loss-text)]">
...
function ValidationLineList({
  ...
  return (
    <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
      <div className="text-[9px] font-bold text-[var(--franchise-gold)]">{label}</div>
      {entries.length === 0 ? (
        <div className="mt-1 text-[10px] leading-snug text-[var(--franchise-text)]/55">{empty}</div>
      ) : (
        <div className="mt-2 space-y-1 text-[10px] leading-snug text-[var(--franchise-text)]/75">
...
function FranchiseManualOverridePreviewPanel({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <div className="text-[9px] font-bold text-[var(--franchise-gold)]">MANUAL OVERRIDE PREVIEW</div>
          <div className="mt-1 text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      {hiddenTruthGuard && (
        <div className="mt-3 border-2 border-[var(--franchise-loss-panel)] bg-[var(--franchise-loss-panel)] p-2 text-[10px] leading-snug text-[var(--franchise-loss-text)]">
          <div className="font-bold text-[var(--franchise-gold-soft)]">
...
function FranchiseRelationshipContextPanel({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <div className="text-[9px] font-bold text-[var(--franchise-gold)]">RELATIONSHIP CONTEXT</div>
          <div className="mt-1 text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      {!report ? (
        ...
        <>
          <div className="mt-3 grid gap-2 md:grid-cols-3">
            {report.rows.map((row) => (
              <div key={row.kind} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[10px] leading-snug text-[var(--franchise-text)]">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <span className="font-bold text-[var(--franchise-gold)]">{row.label}</span>
                  <FoundationStatusBadge status={row.status} />
                </div>
                <div className="mt-2 text-[var(--franchise-text)]/70">
                ...
                {row.evidenceDescriptions.slice(0, 2).map((description) => (
                  <div key={description} className="mt-1 text-[var(--franchise-text)]/60">{description}</div>
                ))}
                {row.blockers.slice(0, 2).map((blocker) => (
                  <div key={blocker} className="mt-1 text-[var(--franchise-loss-text)]">{blocker}</div>
                ))}
                {row.warnings.slice(0, 2).map((warning) => (
                  <div key={warning} className="mt-1 text-[var(--franchise-gold-amber)]">{warning}</div>
                ))}
              </div>
            ))}
          </div>
...
function ContinuityMiniList({
  ...
  return (
    <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
      <div className="text-[7px] font-bold text-[var(--franchise-gold)]">{title}</div>
      {entries.length === 0 ? (
        <div className="mt-1 text-[8px] text-[var(--franchise-text)]/55">{empty}</div>
      ) : (
        <div className="mt-2 space-y-1 text-[8px] text-[var(--franchise-text)]/75">
...
function FranchisePlayerContinuityPanel({
  ...
  return (
    <section className="mt-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-3">
      <div className="text-[9px] font-bold text-[var(--franchise-gold)]">PLAYER CONTINUITY</div>
      <div className="mt-1 text-[8px] text-[var(--franchise-text)]/65">
      ...
      {error && (
        <div className="mt-3 border-2 border-[var(--franchise-loss)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
          {error}
        </div>
      )}
      {!isLoading && !error && report && (
        <>
          ...
          {report.limitations.length > 0 && (
            <div className="mt-3 border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[8px] text-[var(--franchise-text)]/60">
...
function ProfileTextInput({
  ...
  return (
    <label className="block border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
      <span className="block text-[7px] font-bold text-[var(--franchise-gold)]">{label}</span>
      <input
        aria-label={label}
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="mt-1 w-full border-2 border-[var(--franchise-panel-dark)] bg-[var(--franchise-panel)] p-1 text-[9px] text-[var(--franchise-text)]"
      />
    </label>
  );
}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div
        ...
        className="max-h-[90vh] w-full max-w-3xl overflow-y-auto border-[5px] border-[var(--franchise-border)] bg-[var(--franchise-header)] p-4 text-[var(--franchise-text)] shadow-[8px_8px_0px_rgba(0,0,0,0.35)]"
      >
        <div className="mb-4 flex flex-wrap items-start justify-between gap-3 border-b-2 border-[var(--franchise-border)] pb-3">
          <div>
            <div className="text-[8px] font-bold text-[var(--franchise-gold)]">FRANCHISE PLAYER PROFILE</div>
            ...
            {profile.hiddenSafe && (
              <div className="mt-1 text-[8px] text-[var(--franchise-gold-soft)]">
            ...
            {editMode ? (
              <>
                <button
                  ...
                  disabled={isSaving}
                  className="border-2 border-[var(--franchise-text)]/40 bg-[var(--franchise-border)] px-3 py-1 text-[8px] font-bold hover:border-[var(--franchise-gold)] disabled:opacity-40"
                >
                  CANCEL
                </button>
                <button
                  ...
                  className="border-2 border-[var(--franchise-text)] bg-[var(--franchise-border)] px-3 py-1 text-[8px] font-bold hover:border-[var(--franchise-gold)] disabled:opacity-40"
                >
              ...
              <button
                type="button"
                onClick={onStartEdit}
                className="border-2 border-[var(--franchise-text)] bg-[var(--franchise-border)] px-3 py-1 text-[8px] font-bold hover:border-[var(--franchise-gold)]"
              >
        ...
        {editErrors.length > 0 && (
          <div className="mb-3 border-2 border-[var(--franchise-loss)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
        ...
        {profile.hiddenSafe ? (
          <section className="mt-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-3">
            <div className="text-[9px] font-bold text-[var(--franchise-gold)]">VISIBLE SCOUTING REPORT</div>
            <div className="mt-1 text-[8px] text-[var(--franchise-text)]/65">
          ...
          <section className="mt-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-3">
            <div className="text-[9px] font-bold text-[var(--franchise-gold)]">BASEBALL DETAILS</div>
            {editMode && form ? (
              <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                {pitchingModelAvailable ? (
                  ...
                  <div className="border-2 border-[var(--franchise-text)]/15 bg-[var(--franchise-shadow)] p-2 text-[8px] text-[var(--franchise-text)]/70 sm:col-span-2 lg:col-span-3">
...
function foundationStatusClass(status: string): string {
  ...
  if (status === 'preview-only' || status === 'projected' || status === 'estimate' || status === 'partial' || status === 'needs-approval' || status === 'ready-for-review') return 'border-[var(--franchise-gold-amber)]/60 text-[var(--franchise-gold-amber)]';
  if (status === 'deferred' || status === 'not-applicable') return 'border-[var(--franchise-text)]/35 text-[var(--franchise-text)]/75';
  if (status === 'dismissed') return 'border-[var(--franchise-text)]/25 text-[var(--franchise-text)]/45';
  return 'border-[var(--franchise-loss-text)]/60 text-[var(--franchise-loss-text)]';
}
  ...
  return (
    <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2">
      <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
        <div className="text-[9px] font-bold text-[var(--franchise-gold)]">{title}</div>
        <FoundationStatusBadge status={status} />
      </div>
      <div className="text-[10px] leading-snug text-[var(--franchise-text)]/75">{body}</div>
    </div>
  );
}
...
function FranchiseStadiumFoundationPanel({
  ...
  return (
    <section
      ...
      className="border-[5px] border-[var(--franchise-border)] bg-[var(--franchise-header)] p-4"
    >
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <Building2 className="mt-1 h-6 w-6 text-[var(--franchise-gold)]" />
          <div>
            <div className="text-[14px] font-bold text-[var(--franchise-text)]">STADIUM FOUNDATION</div>
            <div className="mt-1 max-w-3xl text-[10px] leading-snug text-[var(--franchise-text)]/70">
      ...
      <div className="mb-4 grid gap-3 lg:grid-cols-[minmax(220px,0.8fr)_minmax(0,1.2fr)]">
        <label className="block">
          <div className="mb-1 text-[10px] font-bold text-[var(--franchise-gold)]">STADIUM</div>
          <select
            value={selected?.stadiumName ?? selectedStadium}
            onChange={(event) => onSelectedStadiumChange(event.target.value)}
            className="w-full border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] px-3 py-2 text-[11px] text-[var(--franchise-text)]"
      ...
      <div className="mb-3 flex flex-wrap gap-1.5 border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-2 text-[9px] font-bold text-[var(--franchise-text)]/75">
        <span className="border border-[var(--franchise-text)]/20 bg-[var(--franchise-border)] px-2 py-0.5">{stadiumSourceLabel}</span>
        <span className={`border px-2 py-0.5 ${
          dimensions ? 'border-[var(--franchise-win-bright)]/45 bg-[var(--franchise-shadow-green)] text-[var(--franchise-win-soft)]' : 'border-[var(--franchise-gold-amber)]/45 bg-[var(--franchise-gold-deep)] text-[var(--franchise-gold-soft)]'
        }`}>{dimensionsSourceLabel}</span>
        <span className={`border px-2 py-0.5 ${
          selected?.seedParkFactorsTrusted ? 'border-[var(--franchise-win-bright)]/45 bg-[var(--franchise-shadow-green)] text-[var(--franchise-win-soft)]' : 'border-[var(--franchise-gold-amber)]/45 bg-[var(--franchise-gold-deep)] text-[var(--franchise-gold-soft)]'
        }`}>{seedSourceLabel}</span>
        <span className="border border-[var(--franchise-text)]/20 bg-[var(--franchise-border)] px-2 py-0.5">Custom dimensions blocked</span>
      </div>

      <div className="grid gap-3 xl:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.65fr)]">
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
          <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
            <div>
              <div className="text-[12px] font-bold text-[var(--franchise-gold)]">SPRAY CHART</div>
              <div className="mt-1 text-[9px] leading-snug text-[var(--franchise-text)]/60">
                Graphic plot from scoped completed-game spray evidence. Heat map remains deferred.
              </div>
            </div>
            <div className="text-[9px] font-bold text-[var(--franchise-text)]/60">
        ...
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
          <div className="mb-2 text-[10px] font-bold text-[var(--franchise-gold)]">EVIDENCE FILTERS</div>
          {hasScopedSprayRows ? (
            <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
                <div
                  className="border border-[var(--franchise-text)]/20 bg-[var(--franchise-panel-darker)] p-2 text-[9px] leading-snug text-[var(--franchise-text)]/65"
                  data-testid="spray-scope-filter-summary"
                >
                  <div className="font-bold text-[var(--franchise-gold)]">Scope</div>
            ...
            <div className="text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      <div className="mt-3 grid gap-3 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,0.65fr)_minmax(0,1fr)]">
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
          <div className="mb-2 text-[10px] font-bold text-[var(--franchise-gold)]">STADIUM STATS / ADVANCED METRICS</div>
          {selected ? (
            <div className="space-y-2 text-[10px] leading-snug text-[var(--franchise-text)]/75">
              <div className="text-[12px] font-bold text-[var(--franchise-text)]">{selected.stadiumName}</div>
              {dimensions ? (
                <div className="grid gap-2 sm:grid-cols-3">
                  <div className="border border-[var(--franchise-text)]/20 p-2">LF {dimensions.lf}</div>
                  <div className="border border-[var(--franchise-text)]/20 p-2">CF {dimensions.cf}</div>
                  <div className="border border-[var(--franchise-text)]/20 p-2">RF {dimensions.rf}</div>
                </div>
              ) : (
              ...
              <div className="text-[var(--franchise-text)]/55">
                Adaptive factors are preview-only. Park-adjusted WAR/value consumers remain blocked.
              </div>
            </div>
          ) : (
            <div className="text-[10px] text-[var(--franchise-text)]/65">
        ...
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
          <div className="mb-2 text-[10px] font-bold text-[var(--franchise-gold)]">STADIUM RECORDS</div>
          <div className="space-y-2 text-[10px] leading-snug text-[var(--franchise-text)]/70">
            ...
            <div className="border border-[var(--franchise-text)]/20 bg-[var(--franchise-panel-darker)] p-2 text-[var(--franchise-text)]/60">
        ...
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
          <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
            <div className="text-[10px] font-bold text-[var(--franchise-gold)]">SPRAY EVIDENCE DETAILS</div>
            <div className="text-[9px] font-bold text-[var(--franchise-text)]/60">
              {filteredSprayRows.length} ROW(S) · READ ONLY
            </div>
          </div>
          <div className="mb-2 text-[9px] leading-snug text-[var(--franchise-text)]/55">
              ...
              {visibleSprayRows.length > 0 ? (
                <div className="space-y-2">
                  {visibleSprayRows.map((row) => (
                    <article key={`${row.role}:${row.eventId}:${row.playerId}`} className="border border-[var(--franchise-text)]/20 p-2 text-[10px] leading-snug text-[var(--franchise-text)]/75">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <span className="font-bold text-[var(--franchise-text)]">{row.playerName}</span>
                        <span className="text-[var(--franchise-gold)]">{row.role.toUpperCase()}</span>
                      </div>
                      <div>
                      ...
                      <div className="text-[var(--franchise-text)]/50">
                        Source game {row.gameId} · Evidence {row.eventId} · Source {row.source}
                      </div>
                    </article>
                  ))}
                  {filteredSprayRows.length > visibleSprayRows.length && (
                    <div className="border border-[var(--franchise-text)]/15 p-2 text-[10px] text-[var(--franchise-text)]/60">
                      Showing first {visibleSprayRows.length} filtered row(s). Narrow the filters to inspect the remaining evidence.
                    </div>
                  )}
                </div>
              ) : (
                <div className="border border-[var(--franchise-text)]/15 p-2 text-[10px] leading-snug text-[var(--franchise-text)]/65">
...
function SprayFilterSelect({
  ...
  return (
    <label className="block">
      <div className="mb-1 text-[9px] font-bold text-[var(--franchise-gold)]">{label}</div>
      <select
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="w-full border border-[var(--franchise-text)]/20 bg-[var(--franchise-panel-darker)] px-2 py-1.5 text-[10px] text-[var(--franchise-text)]"
  ...
  return (
    <div>
      <svg
        ...
        viewBox="0 0 100 100"
        className="h-[360px] w-full border-2 border-[var(--franchise-panel-pine)] bg-[var(--franchise-shadow-deep)]"
      ...
      <div className="mt-2 flex flex-wrap gap-2 text-[9px] font-bold text-[var(--franchise-text)]/70">
        <span className="border border-[var(--franchise-gold-pale)]/50 px-2 py-1 text-[var(--franchise-gold-pale)]">● Batting {groupedByRole.batting}</span>
        <span className="border border-[var(--franchise-info-sage)]/50 px-2 py-1 text-[var(--franchise-win-mint-alt)]">▲ Pitching {groupedByRole.pitching}</span>
        <span className="border border-[var(--franchise-info-steel)]/50 px-2 py-1 text-[var(--franchise-info-pale)]">■ Fielding {groupedByRole.fielding}</span>
        <span className="border border-[var(--franchise-text)]/20 px-2 py-1">
          {dimensionsAvailable ? 'Trusted dimensions' : 'Default field layout'}
        </span>
        {rows.length > plottedRows.length ? (
          <span className="border border-[var(--franchise-text)]/20 px-2 py-1">Showing first {plottedRows.length} points</span>
        ) : null}
      </div>
    </div>
  );
...
function FranchiseFanMoralePanel({
  ...
  return (
    <div className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-4">
      <div className="mb-3 flex flex-wrap items-start justify-between gap-2 border-b-2 border-[var(--franchise-border)] pb-2">
        <div>
          <div className="text-[12px] font-bold text-[var(--franchise-text)]" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
            FAN MORALE
          </div>
          <div className="mt-1 text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      <div className="grid gap-3 lg:grid-cols-[260px_1fr]">
        <section className="border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-3" aria-label="Selected team fan morale">
          <div className="text-[10px] font-bold text-[var(--franchise-gold)]">SELECTED TEAM</div>
          <div className="mt-1 text-[12px] font-bold text-[var(--franchise-text)]">{selectedTeamName || 'No team selected'}</div>
          <div className="mt-3 text-[36px] font-black leading-none text-[var(--franchise-text)]">
            {specView.currentValue}
          </div>
          <div className="mt-1 text-[10px] font-bold text-[var(--franchise-gold)]">
            {specView.state} · {specView.trend} · {specView.riskLevel}
          </div>
          <div className="mt-1 text-[10px] text-[var(--franchise-text)]/65">
        ...
        <section className="border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-3" aria-label="Fan morale history">
          <div className="mb-2 text-[10px] font-bold text-[var(--franchise-gold)]">EVENT-BACKED HISTORY</div>
          {teamFanSnapshot?.history.length ? (
            <div className="space-y-2">
              {teamFanSnapshot.history.slice().reverse().slice(0, 6).map((entry) => (
                <div key={entry.id} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[10px] leading-snug text-[var(--franchise-text)]/75">
                  <div className="font-bold text-[var(--franchise-text)]">
                    {entry.previousValue} → {entry.currentValue} ({entry.delta > 0 ? '+' : ''}{entry.delta})
                  </div>
                  <div className="mt-1">{entry.reason}</div>
                  <div className="mt-1 text-[var(--franchise-text)]/55">
            ...
            <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3 text-[10px] leading-snug text-[var(--franchise-text)]/65">
...
function FranchiseRandomEventLogPanel({
  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-[10px] font-bold text-[var(--franchise-gold)]">RANDOM EVENT LOG</div>
          <div className="mt-1 text-[10px] leading-snug text-[var(--franchise-text)]/65">
      ...
      <div className="mb-3 grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <FoundationStatusCard
          title="AUTOMATION"
          status="blocked"
          body="Profile, relationship, salary, story, park-factor, designation-effect, and Mode 3 mutations remain blocked."
        />
      </div>

      <div
        className="mb-3 grid gap-2 text-[10px] leading-snug text-[var(--franchise-text)]/75 md:grid-cols-4"
        aria-label="Random event manual review workflow"
      >
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-2">
          <div className="font-bold text-[var(--franchise-gold)]">1. EVIDENCE</div>
          <div>Generated from scoped archive, schedule, roster, profile, or stadium facts.</div>
        </div>
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-2">
          <div className="font-bold text-[var(--franchise-gold)]">2. SAFE EFFECT</div>
          <div>Review the exact team fan or revealed player morale target before acting.</div>
        </div>
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-2">
          <div className="font-bold text-[var(--franchise-gold)]">3. DECISION</div>
          <div>Confirm to persist the decision and apply allowed morale; dismiss to skip it.</div>
        </div>
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-2">
          <div className="font-bold text-[var(--franchise-gold)]">4. VERIFY</div>
          <div>Check Fan Morale or Player Profile history after confirmation.</div>
        </div>
      </div>

      {report?.blockers.length ? (
        <div className="mb-3 border-2 border-[var(--franchise-loss)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[10px] leading-snug text-[var(--franchise-loss-text)]">
      ...
      {visibleRecords.length > 0 ? (
        <div className="space-y-2">
          {visibleRecords.map((record) => {
            ...
            return (
            <article key={record.id} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
              <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                <div className="text-[10px] font-bold text-[var(--franchise-text)]">{entry.title}</div>
              ...
              <div className="mb-2 grid gap-2 text-[10px] leading-snug text-[var(--franchise-text)]/70 md:grid-cols-3">
                <div className="border border-[var(--franchise-text)]/20 p-2">
                  <span className="font-bold text-[var(--franchise-gold)]">Source:</span> {sourceLabel}
                </div>
                <div className="border border-[var(--franchise-text)]/20 p-2">
                  <span className="font-bold text-[var(--franchise-gold)]">Safe target:</span> {targetLabel}
                </div>
                <div className="border border-[var(--franchise-text)]/20 p-2">
                  <span className="font-bold text-[var(--franchise-gold)]">Follow-up:</span> {followUpLabel}
                </div>
              </div>
              <div className="grid gap-2 text-[10px] leading-snug text-[var(--franchise-text)]/75 lg:grid-cols-2">
                <div>
                  <div className="mb-1 font-bold text-[var(--franchise-gold)]">Evidence / reason</div>
                ...
                <div>
                  <div className="mb-1 font-bold text-[var(--franchise-gold)]">Suggested manual change</div>
              ...
              <div className="mt-2 grid gap-2 text-[10px] leading-snug lg:grid-cols-2">
                <div className="border border-[var(--franchise-text)]/20 p-2 text-[var(--franchise-text)]/70">
                  <div className="mb-1 font-bold text-[var(--franchise-gold)]">Safe-effect preview</div>
                  <div>
                  ...
                  {effectPreview.blockers.length > 0 && (
                    <div className="mt-1 text-[var(--franchise-loss-text)]">{effectPreview.blockers.join(' ')}</div>
                  )}
                  {effectPreview.warnings.length > 0 && (
                    <div className="mt-1 text-[var(--franchise-gold-amber)]">{effectPreview.warnings.join(' ')}</div>
                  )}
                </div>
                <div className="border border-[var(--franchise-text)]/20 p-2 text-[var(--franchise-text)]/70">
                  <div className="mb-1 font-bold text-[var(--franchise-gold)]">Applied state</div>
              ...
              <div className="mt-2 border border-[var(--franchise-text)]/20 p-2 text-[10px] leading-snug text-[var(--franchise-text)]/65">
                {record.narrativeReadableStatus}
              </div>
              {entry.warnings.length > 0 && (
                <div className="mt-2 text-[10px] leading-snug text-[var(--franchise-gold-amber)]">
                  {entry.warnings.join(' ')}
                </div>
              )}
              <div className="mt-2 flex flex-wrap gap-2">
                <button
                  ...
                  className="border-2 border-[var(--franchise-gold)] bg-[var(--franchise-header)] px-3 py-1 text-[10px] font-bold text-[var(--franchise-text)] hover:bg-[var(--franchise-panel)] disabled:cursor-not-allowed disabled:opacity-40"
                >
                  CONFIRM
                </button>
                <button
                  ...
                  className="border-2 border-[var(--franchise-text)]/30 bg-[var(--franchise-loss-panel)] px-3 py-1 text-[10px] font-bold text-[var(--franchise-text)] hover:border-[var(--franchise-gold)] disabled:cursor-not-allowed disabled:opacity-40"
                >
                  DISMISS
                </button>
              </div>
      ...
      <div className="mt-3 border-2 border-[var(--franchise-border)] bg-[var(--franchise-loss-panel)] p-2 text-[10px] leading-snug text-[var(--franchise-loss-text)]">
...
function FranchiseValueTruthPanel({
  ...
  const frozenTrueValueArtifact = Boolean(valueInputReport?.trustedValueArtifactFrozen);
  const finalTrueValueCalculated = Boolean(valueInputReport?.trueValuePolicy.finalTrueValueCalculated);
  const trueValueMovementLabel = frozenTrueValueArtifact
    ? 'TRUSTED (frozen artifact; now also feeds Albatross/Fan Favorite + awards).'
    : finalTrueValueCalculated
      ? 'PROJECTED (trusted inputs exist; final/trusted label waits for season-end freeze).'
      : 'BLOCKED until trusted value inputs exist.';
  ...
  const blockedDesignationSummaries = uniqueStrings(
    designationRecords
      ...
      .filter((record) => !['TEAM_MVP', 'ACE', 'FAN_FAVORITE', 'ALBATROSS', 'CAPTAIN', 'FAN_HOPEFUL'].includes(record.designationType))
  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-[9px] font-bold text-[var(--franchise-gold)]">VALUE / SALARY / DESIGNATION TRUTH</div>
          <div className="mt-1 text-[8px] text-[var(--franchise-text)]/60">
            Franchise v1 salary values are current salary state. Morale, salary movement, and downstream effect mutations remain blocked.
          </div>
        </div>
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] px-2 py-1 text-[8px] text-[var(--franchise-text)]">
          {isLoading ? 'LOADING' : 'READ ONLY'}
        </div>
      </div>
      ...
      <div className="grid gap-3 lg:grid-cols-3">
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[8px] text-[var(--franchise-text)]/75">
          <div className="mb-1 font-bold text-[var(--franchise-gold)]">CURRENT SALARY</div>
          <div>
          ...
          {teamPayrollRecord?.payrollBaseline == null && (
            <div className="text-[var(--franchise-gold-soft)]">Team payroll proof limitation: missing handoff payroll proof.</div>
          )}
        </div>

        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[8px] text-[var(--franchise-text)]/75">
          <div className="mb-1 font-bold text-[var(--franchise-gold)]">VALUE MOVEMENT</div>
          ...
          <div>True Value / value delta: {trueValueMovementLabel}</div>
          <div>Luxury tax, salary matching, and AI salary valuation: BLOCKED / INACTIVE.</div>
        </div>

        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-2 text-[8px] text-[var(--franchise-text)]/75">
          <div className="mb-1 font-bold text-[var(--franchise-gold)]">DYNAMIC DESIGNATIONS</div>
          {activeDesignationLabels.length > 0 && (
            <div>{activeDesignationLabels.join(', ')} live canonical designation(s); morale, salary, award-effect, and relationship mutations are not applied.</div>
          )}
          ...
          <div>Designation persistence: live engine designation rows can be ACTIVE; non-live rows remain PROJECTED.</div>
          <div>Season-end locks, morale effects, and trade discounts remain blocked.</div>
        </div>
      </div>
      ...
      {(blockedDesignationSummaries.length > 0 || salaryLimitations.length > 0) && (
        <div className="mt-3 grid gap-2 lg:grid-cols-2">
          {blockedDesignationSummaries.length > 0 && (
            <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
              <div className="mb-1 font-bold text-[var(--franchise-gold-soft)]">Blocked / deferred designation reasons</div>
          ...
          {salaryLimitations.length > 0 && (
            <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
              <div className="mb-1 font-bold text-[var(--franchise-gold-soft)]">Salary context limitations</div>
      ...
      <div className="mt-3 text-[8px] text-[var(--franchise-text)]/55">
...
function FranchiseTransactionHistoryPanel({
  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-[9px] font-bold text-[var(--franchise-gold)]">READ-ONLY TRANSACTION HISTORY</div>
          <div className="mt-1 text-[8px] text-[var(--franchise-text)]/60">
      ...
      {isLoading && (
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3 text-[8px] text-[var(--franchise-text)]/65">
          Loading scoped transaction history...
        </div>
      )}

      {!isLoading && error && (
        <div className="border-2 border-[var(--franchise-gold)]/50 bg-[var(--franchise-loss-panel)] p-3 text-[8px] text-[var(--franchise-loss-text)]">
          {error}
        </div>
      )}
      ...
      {!isLoading && !error && transactions.length > 0 && (
        <div className="space-y-2">
          {transactions.map((entry) => (
            <div key={entry.id} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <div className="text-[9px] font-bold text-[var(--franchise-text)]">{formatTeamHubTransactionType(entry.type)}</div>
                  <div className="mt-1 text-[7px] text-[var(--franchise-text)]/55">
                    {entry.id} / {formatTeamHubTransactionTimestamp(entry.timestamp)}
                  </div>
                </div>
                <div className="border-2 border-[var(--franchise-panel)] px-2 py-1 text-[7px] font-bold text-[var(--franchise-gold)]">
                  {entry.phase}
                </div>
              </div>
              <div className="mt-3 grid gap-2 text-[8px] text-[var(--franchise-text)]/75 md:grid-cols-3">
                <div>
                  <div className="text-[var(--franchise-text)]/50">Players</div>
                  <div>{describeTeamHubTransactionPlayers(entry)}</div>
                </div>
                <div>
                  <div className="text-[var(--franchise-text)]/50">Teams</div>
                  <div>{describeTeamHubTransactionTeams(entry)}</div>
                </div>
                <div>
                  <div className="text-[var(--franchise-text)]/50">Status</div>
...
function DirectorySelect({
  ...
  return (
    <label className="block">
      <span className="block text-[8px] font-bold text-[var(--franchise-gold)]">{label}</span>
      <select
        aria-label={label}
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="mt-1 min-h-10 w-full border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] px-2 py-2 text-[10px] text-[var(--franchise-text)]"
      >
        {children}
      </select>
    </label>
...
function FranchisePlayerDirectoryPanel({
  ...
  return (
    <section
      ...
      className="bg-[var(--franchise-header)] border-[5px] border-[var(--franchise-border)] p-4"
    >
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-[11px] font-bold text-[var(--franchise-text)]">FRANCHISE PLAYER DIRECTORY</div>
          <div className="mt-1 text-[8px] text-[var(--franchise-text)]/65">
            Read-only franchise-owned players. Hidden FARM rows use visible scouting grades only.
          </div>
        </div>
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] px-3 py-2 text-[9px] text-[var(--franchise-text)]">
      ...
      <div className="mb-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        <label className="block md:col-span-2 xl:col-span-1">
          <span className="block text-[8px] font-bold text-[var(--franchise-gold)]">SEARCH PLAYER NAME</span>
          <input
            aria-label="Search player name"
            value={search}
            onChange={(event) => onSearchChange(event.target.value)}
            placeholder="Type a player name..."
            className="mt-1 min-h-10 w-full border-2 border-[var(--franchise-border)] bg-[var(--franchise-panel)] px-3 py-2 text-[10px] text-[var(--franchise-text)] placeholder:text-[var(--franchise-text)]/35"
          />
        </label>
      ...
      {rows.length === 0 ? (
        <div className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-4 text-[9px] text-[var(--franchise-text)]/65">
        ...
        <div className="space-y-3">
          {rows.map((row) => (
            <div
              key={row.playerId}
              className="border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel)] p-3"
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <div className="text-[12px] font-bold text-[var(--franchise-text)]">{row.name}</div>
                  <div className="mt-1 flex flex-wrap gap-2 text-[8px] text-[var(--franchise-text)]/70">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    <span className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] px-2 py-1 text-[8px] font-bold text-[var(--franchise-gold)]">
                      {row.revealState.toUpperCase()}
                    </span>
                    <span className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] px-2 py-1 text-[8px] text-[var(--franchise-text)]">
                      {row.gradeLabel}
                    </span>
                  </div>
                </div>
                <button
                  ...
                  className="min-h-10 border-2 border-[var(--franchise-text)]/30 bg-[var(--franchise-border)] px-4 py-2 text-[9px] font-bold text-[var(--franchise-text)] hover:border-[var(--franchise-gold)]"
                >
                  PROFILE
                </button>
              </div>
...
function FranchiseFarmVisibilityPanel({
  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-[9px] font-bold text-[var(--franchise-gold)]">FARM PROSPECTS</div>
          <div className="mt-1 text-[8px] text-[var(--franchise-text)]/60">
      ...
      {farmPlayers.length === 0 ? (
        ...
        <div className="grid gap-3 lg:grid-cols-2">
          {farmPlayers.map((player) => {
            ...
            return (
              <div key={player.id} className="border-2 border-[var(--franchise-border)] bg-[var(--franchise-border)] p-3">
                <div className="mb-2 flex items-start justify-between gap-3">
                  <div>
                    <div className="text-[10px] font-bold text-[var(--franchise-text)]">{getFranchisePlayerName(player)}</div>
                    <div className="mt-1 text-[8px] text-[var(--franchise-text)]/65">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <button
                      ...
                      className="border-2 border-[var(--franchise-text)]/25 bg-[var(--franchise-panel)] px-2 py-1 text-[7px] font-bold text-[var(--franchise-text)] hover:border-[var(--franchise-gold)]"
                    >
                      PROFILE
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-[8px] text-[var(--franchise-text)]/75">
                  <div>Scouted: <span className="font-bold text-[var(--franchise-text)]">{metadata.scoutedGrade ?? 'Unscouted'}</span></div>
                  <div>Potential: <span className="font-bold text-[var(--franchise-text)]">{metadata.potentialGrade ?? 'Unknown'}</span></div>
                ...
                {!record && (
                  <div className="mt-2 border-2 border-[var(--franchise-gold)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
      ...
      {(missingRecordPlayers.length > 0 || orphanFarmRecords.length > 0) && (
        <div className="mt-3 space-y-2">
          {missingRecordPlayers.map((player) => (
            <div key={`missing-${player.id}`} className="border-2 border-[var(--franchise-gold)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
              Missing FARM record for FARM-assigned player {getFranchisePlayerName(player)}.
            </div>
          ))}
          {orphanFarmRecords.map((record) => (
            <div key={`orphan-${record.id}`} className="border-2 border-[var(--franchise-gold)]/50 bg-[var(--franchise-loss-panel)] p-2 text-[8px] text-[var(--franchise-loss-text)]">
...
function FranchiseRosterAnalyzerPanel({ report }: FranchiseRosterAnalyzerPanelProps) {
  ...
  return (
    <div className="mb-4 border-[4px] border-[var(--franchise-border)] bg-[var(--franchise-panel-darker)] p-3">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-[9px] font-bold text-[var(--franchise-gold)]">READ-ONLY ROSTER ANALYZER</div>
          <div className="mt-1 text-[8px] text-[var(--franchise-text)]/60">
          ...
          <div className="mt-2 flex flex-wrap gap-2 text-[8px] font-bold">
            <span className="border-2 border-[var(--franchise-text)]/25 bg-[var(--franchise-shadow)] px-2 py-1">
          ...
          {visibleFindings.length > 0 ? (
            <div className="space-y-1">
              {visibleFindings.map((finding) => (
                <div key={finding.id} className="text-[var(--franchise-text)]">
                  <span className="font-bold text-[var(--franchise-gold-hint)]">{finding.severity.toUpperCase()}</span>
                  <span className="text-[var(--franchise-text)]/80"> · {finding.title}</span>
                </div>
              ))}
            </div>
          ) : (
            <div className="font-bold text-[var(--franchise-win-mint)]">No critical readiness issues found.</div>
          )}
          {limitations.length > 0 && (
            <div className="mt-2 text-[var(--franchise-text)]/60">
              {limitations.join(' ')}
            </div>
          )}
          {farmAdvice.length > 0 && (
            <div className="mt-2 border-t border-[var(--franchise-text)]/20 pt-2">
              <div className="mb-1 font-bold text-[var(--franchise-gold)]">Farm advisory only</div>
              {farmAdvice.map((recommendation) => (
                <div key={recommendation.id} className="text-[var(--franchise-text)]/75">
