...
function TradeInterfaceContent() {
  const [tradeMode, setTradeMode] = useState<"two-way" | "three-way">("two-way");
  const [team1, setTeam1] = useState<string>("tigers");
  const [team2, setTeam2] = useState<string>("sox");
  const [team3, setTeam3] = useState<string>("crocs");
  const [team1Selected, setTeam1Selected] = useState<string[]>([]);
  const [team2Selected, setTeam2Selected] = useState<string[]>([]);
  const [team3Selected, setTeam3Selected] = useState<string[]>([]);
  const [selectedPlayerCard, setSelectedPlayerCard] = useState<any>(null);
  const [tradeProposed, setTradeProposed] = useState(false);
  
  // Player destinations for three-way trades (playerId -> teamNumber)
  const [team1Destinations, setTeam1Destinations] = useState<Record<string, number>>({});
  const [team2Destinations, setTeam2Destinations] = useState<Record<string, number>>({});
  const [team3Destinations, setTeam3Destinations] = useState<Record<string, number>>({});

  // Mock teams list
  const teams = [
    { id: "tigers", name: "Tigers" },
    { id: "sox", name: "Sox" },
    { id: "crocs", name: "Crocodiles" },
    { id: "moonstars", name: "Moonstars" },
    { id: "nemesis", name: "Nemesis" },
    { id: "herbisaurs", name: "Herbisaurs" },
    { id: "wildpigs", name: "Wild Pigs" },
    { id: "beewolves", name: "Beewolves" },
  ];

  // Mock player rosters with salaries and attributes
  const mockRosters: Record<string, any[]> = {
    tigers: [
      { id: "t1", name: "J. Rodriguez", pos: "CF", salary: "$15.2M", ovr: 92, con: 85, pow: 88, spd: 91, fld: 89, arm: 82 },
      { id: "t2", name: "M. Chen", pos: "SP", salary: "$12.5M", ovr: 88, vel: 90, junk: 85, acc: 87, stamina: 82 },
      { id: "t3", name: "R. Davis", pos: "3B", salary: "$8.3M", ovr: 84, con: 82, pow: 86, spd: 75, fld: 83, arm: 88 },
      { id: "t4", name: "L. Martinez", pos: "C", salary: "$6.1M", ovr: 81, con: 79, pow: 83, spd: 65, fld: 85, arm: 90 },
      { id: "t5", name: "K. Wilson", pos: "RP", salary: "$4.2M", ovr: 78, vel: 88, junk: 76, acc: 80, stamina: 70 },
    ],
    sox: [
      { id: "s1", name: "K. Martinez", pos: "SS", salary: "$14.8M", ovr: 91, con: 88, pow: 84, spd: 86, fld: 90, arm: 87 },
      { id: "s2", name: "T. Anderson", pos: "2B", salary: "$11.2M", ovr: 87, con: 90, pow: 78, spd: 82, fld: 86, arm: 80 },
      { id: "s3", name: "D. Brown", pos: "SP", salary: "$9.5M", ovr: 85, vel: 87, junk: 83, acc: 86, stamina: 85 },
      { id: "s4", name: "P. Johnson", pos: "LF", salary: "$7.0M", ovr: 82, con: 80, pow: 85, spd: 79, fld: 81, arm: 77 },
      { id: "s5", name: "A. Garcia", pos: "RP", salary: "$3.8M", ovr: 77, vel: 85, junk: 74, acc: 78, stamina: 68 },
    ],
    crocs: [
      { id: "c1", name: "M. Thompson", pos: "1B", salary: "$16.5M", ovr: 93, con: 86, pow: 95, spd: 72, fld: 82, arm: 75 },
      { id: "c2", name: "L. Ramirez", pos: "RF", salary: "$13.1M", ovr: 89, con: 91, pow: 85, spd: 88, fld: 84, arm: 86 },
      { id: "c3", name: "S. Kim", pos: "SP", salary: "$10.8M", ovr: 86, vel: 89, junk: 84, acc: 85, stamina: 88 },
      { id: "c4", name: "J. Taylor", pos: "C", salary: "$5.9M", ovr: 80, con: 77, pow: 82, spd: 63, fld: 87, arm: 91 },
      { id: "c5", name: "N. White", pos: "RP", salary: "$4.5M", ovr: 79, vel: 90, junk: 75, acc: 79, stamina: 72 },
    ],
    moonstars: [
      { id: "m1", name: "H. Nakamura", pos: "SP", salary: "$15.0M", ovr: 90, vel: 91, junk: 88, acc: 89, stamina: 86 },
      { id: "m2", name: "Y. Tanaka", pos: "CF", salary: "$12.0M", ovr: 88, con: 87, pow: 81, spd: 93, fld: 88, arm: 84 },
      { id: "m3", name: "K. Sato", pos: "2B", salary: "$8.7M", ovr: 83, con: 85, pow: 76, spd: 84, fld: 89, arm: 81 },
      { id: "m4", name: "R. Ito", pos: "RP", salary: "$6.2M", ovr: 81, vel: 88, junk: 80, acc: 82, stamina: 74 },
      { id: "m5", name: "D. Tanaka", pos: "LF", salary: "$4.0M", ovr: 76, con: 78, pow: 74, spd: 80, fld: 77, arm: 75 },
    ],
    nemesis: [
      { id: "n1", name: "C. Williams", pos: "3B", salary: "$14.2M", ovr: 90, con: 88, pow: 92, spd: 76, fld: 85, arm: 89 },
      { id: "n2", name: "B. Jackson", pos: "SP", salary: "$11.5M", ovr: 87, vel: 88, junk: 86, acc: 88, stamina: 84 },
      { id: "n3", name: "E. Harris", pos: "SS", salary: "$9.2M", ovr: 84, con: 83, pow: 80, spd: 87, fld: 91, arm: 88 },
      { id: "n4", name: "M. Lewis", pos: "C", salary: "$6.8M", ovr: 82, con: 80, pow: 84, spd: 64, fld: 86, arm: 92 },
      { id: "n5", name: "T. Moore", pos: "RP", salary: "$3.5M", ovr: 78, vel: 87, junk: 76, acc: 79, stamina: 69 },
    ],
    herbisaurs: [
      { id: "h1", name: "G. Peterson", pos: "1B", salary: "$13.8M", ovr: 89, con: 84, pow: 91, spd: 70, fld: 80, arm: 74 },
      { id: "h2", name: "F. Lopez", pos: "SP", salary: "$10.9M", ovr: 86, vel: 86, junk: 85, acc: 87, stamina: 83 },
      { id: "h3", name: "V. Ortiz", pos: "RF", salary: "$8.5M", ovr: 83, con: 86, pow: 79, spd: 81, fld: 82, arm: 85 },
      { id: "h4", name: "S. Murphy", pos: "2B", salary: "$6.4M", ovr: 80, con: 82, pow: 75, spd: 83, fld: 84, arm: 78 },
      { id: "h5", name: "A. Clark", pos: "RP", salary: "$4.1M", ovr: 77, vel: 84, junk: 75, acc: 77, stamina: 71 },
    ],
    wildpigs: [
      { id: "w1", name: "P. Richardson", pos: "CF", salary: "$14.5M", ovr: 90, con: 86, pow: 83, spd: 94, fld: 90, arm: 85 },
      { id: "w2", name: "J. Cooper", pos: "SP", salary: "$11.8M", ovr: 87, vel: 89, junk: 84, acc: 86, stamina: 85 },
      { id: "w3", name: "D. Turner", pos: "SS", salary: "$8.9M", ovr: 84, con: 84, pow: 81, spd: 88, fld: 88, arm: 86 },
      { id: "w4", name: "M. Bell", pos: "3B", salary: "$6.7M", ovr: 81, con: 79, pow: 86, spd: 74, fld: 80, arm: 87 },
      { id: "w5", name: "R. Foster", pos: "RP", salary: "$3.9M", ovr: 78, vel: 86, junk: 77, acc: 78, stamina: 70 },
    ],
    beewolves: [
      { id: "b1", name: "L. Carter", pos: "SP", salary: "$15.3M", ovr: 91, vel: 92, junk: 87, acc: 88, stamina: 87 },
      { id: "b2", name: "W. Scott", pos: "1B", salary: "$12.3M", ovr: 88, con: 85, pow: 90, spd: 71, fld: 81, arm: 76 },
      { id: "b3", name: "N. Green", pos: "LF", salary: "$9.0M", ovr: 84, con: 87, pow: 82, spd: 80, fld: 83, arm: 79 },
      { id: "b4", name: "R. Flop", pos: "C", salary: "$5.5M", ovr: 79, con: 74, pow: 77, spd: 62, fld: 82, arm: 89 },
      { id: "b5", name: "K. Adams", pos: "RP", salary: "$4.3M", ovr: 77, vel: 85, junk: 73, acc: 76, stamina: 68 },
    ],
  };

  const togglePlayerSelection = (teamNum: number, playerId: string) => {
    if (teamNum === 1) {
      setTeam1Selected(prev => {
        const isRemoving = prev.includes(playerId);
        if (isRemoving) {
          // Remove destination when unselecting
          setTeam1Destinations(prevDest => {
            const newDest = { ...prevDest };
            delete newDest[playerId];
            return newDest;
          });
        } else if (tradeMode === "three-way") {
          // Set default destination to team 2 for new selections in three-way mode
          setTeam1Destinations(prevDest => ({ ...prevDest, [playerId]: 2 }));
        }
        return isRemoving ? prev.filter(id => id !== playerId) : [...prev, playerId];
      });
    } else if (teamNum === 2) {
      setTeam2Selected(prev => {
        const isRemoving = prev.includes(playerId);
        if (isRemoving) {
          setTeam2Destinations(prevDest => {
            const newDest = { ...prevDest };
            delete newDest[playerId];
            return newDest;
          });
        } else if (tradeMode === "three-way") {
          // Set default destination to team 1 for new selections in three-way mode
          setTeam2Destinations(prevDest => ({ ...prevDest, [playerId]: 1 }));
        }
        return isRemoving ? prev.filter(id => id !== playerId) : [...prev, playerId];
      });
    } else if (teamNum === 3) {
      setTeam3Selected(prev => {
        const isRemoving = prev.includes(playerId);
        if (isRemoving) {
          setTeam3Destinations(prevDest => {
            const newDest = { ...prevDest };
            delete newDest[playerId];
            return newDest;
          });
          ...
          // Set default destination to team 1 for new selections in three-way mode
          setTeam3Destinations(prevDest => ({ ...prevDest, [playerId]: 1 }));
        }
        return isRemoving ? prev.filter(id => id !== playerId) : [...prev, playerId];
      });
    }
  ...
  const getRoster = (teamId: string) => mockRosters[teamId] || [];

  // Set destination for a player in three-way trade
  const setPlayerDestination = (teamNum: number, playerId: string, destinationTeam: number) => {
    if (teamNum === 1) {
      setTeam1Destinations(prev => ({ ...prev, [playerId]: destinationTeam }));
    } else if (teamNum === 2) {
      setTeam2Destinations(prev => ({ ...prev, [playerId]: destinationTeam }));
    } else if (teamNum === 3) {
      setTeam3Destinations(prev => ({ ...prev, [playerId]: destinationTeam }));
    }
  };

  // Parse salary string to number (e.g., "$15.2M" -> 15.2)
  const parseSalary = (salaryStr: string): number => {
    return parseFloat(salaryStr.replace(/[$M]/g, ""));
  };

  // Calculate total salary for selected players
  const calculateTotalSalary = (teamId: string, selectedIds: string[]): number => {
    const roster = getRoster(teamId);
    return selectedIds.reduce((total, playerId) => {
      const player = roster.find(p => p.id === playerId);
      return total + (player ? parseSalary(player.salary) : 0);
    }, 0);
  };

  // Get salary totals
  const team1Total = calculateTotalSalary(team1, team1Selected);
  const team2Total = calculateTotalSalary(team2, team2Selected);
  const team3Total = calculateTotalSalary(team3, team3Selected);

  // Calculate net differences
  const getNetDifference = (): string => {
    if (tradeMode === "two-way") {
      const diff = team2Total - team1Total;
      if (diff > 0) {
        return `Team 1 receives +$${diff.toFixed(1)}M`;
      } else if (diff < 0) {
        return `Team 2 receives +$${Math.abs(diff).toFixed(1)}M`;
      } else {
        return "Equal salary swap";
      }
    } else {
      // Three-way trade
      return `T1: $${team1Total.toFixed(1)}M | T2: $${team2Total.toFixed(1)}M | T3: $${team3Total.toFixed(1)}M`;
    }
  };

  const showPlayerCard = (player: any) => {
  ...
  const acceptTrade = () => {
    ...
    setTeam2Selected([]);
    setTeam3Selected([]);
    setTeam1Destinations({});
    setTeam2Destinations({});
    setTeam3Destinations({});
    setTradeProposed(false);
  };
    ...
    <div className="space-y-4">
      ...
      <div className="bg-[#6B9462] border-[5px] border-[#4A6844] p-4">
        <div className="flex gap-2 mb-4">
          <button
            onClick={() => setTradeMode("two-way")}
            className={`flex-1 py-2 px-4 border-[4px] border-[#4A6844] transition ${
              tradeMode === "two-way" ? "bg-[#4A6844] text-[#E8E8D8]" : "bg-[#5A8352] text-[#E8E8D8]/70 hover:bg-[#4F7D4B]"
            }`}
          >
            <div className="text-[10px] font-bold">TWO-WAY TRADE</div>
          </button>
          <button
            onClick={() => setTradeMode("three-way")}
            className={`flex-1 py-2 px-4 border-[4px] border-[#4A6844] transition ${
              tradeMode === "three-way" ? "bg-[#4A6844] text-[#E8E8D8]" : "bg-[#5A8352] text-[#E8E8D8]/70 hover:bg-[#4F7D4B]"
            }`}
          >
            <div className="text-[10px] font-bold">THREE-WAY TRADE</div>
          </button>
        </div>

        {/* Trade Columns */}
        <div className={`grid ${tradeMode === "three-way" ? "grid-cols-3" : "grid-cols-2"} gap-4`}>
          {/* Team 1 Column */}
          <div className="bg-[#5A8352] border-[4px] border-[#4A6844] p-3">
            <div className="mb-3">
              <label className="text-[8px] text-[#E8E8D8] font-bold mb-1 block">TEAM 1</label>
              <select
                value={team1}
                onChange={(e) => {
                ...
                className="w-full bg-[#4A6844] border-[3px] border-[#E8E8D8]/20 text-[#E8E8D8] text-[9px] p-2 font-bold"
              >
                {teams.map(team => (
            ...
            <div className="space-y-1 max-h-[400px] overflow-y-auto">
              {getRoster(team1).map(player => (
                <div key={player.id}>
                  <div
                    className={`p-2 border-[3px] cursor-pointer transition ${
                      team1Selected.includes(player.id)
                        ? "bg-[#FFD700] border-[#000000]"
                        : "bg-[#4A6844] border-[#5A8352] hover:border-[#E8E8D8]/50"
                    }`}
                    onClick={() => togglePlayerSelection(1, player.id)}
                    onDoubleClick={() => showPlayerCard(player)}
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <div className={`text-[9px] font-bold ${team1Selected.includes(player.id) ? "text-[#000000]" : "text-[#E8E8D8]"}`}>{player.name}</div>
                        <div className={`text-[7px] ${team1Selected.includes(player.id) ? "text-[#000000]/70" : "text-[#E8E8D8]/70"}`}>{player.pos} • OVR {player.ovr}</div>
                      </div>
                      <div className={`text-[8px] font-bold ${team1Selected.includes(player.id) ? "text-[#000000]" : "text-[#E8E8D8]"}`}>{player.salary}</div>
                    </div>
                  </div>
                  {/* Destination selector for three-way trades */}
                  {tradeMode === "three-way" && team1Selected.includes(player.id) && (
                    <div className="mt-1 bg-[#4A6844] border-[2px] border-[#E8E8D8]/30 p-1.5">
                      <div className="flex items-center gap-2">
                        <ArrowRight className="w-3 h-3 text-[#E8E8D8]" />
                        <select
                          value={team1Destinations[player.id] || 2}
                          onChange={(e) => setPlayerDestination(1, player.id, parseInt(e.target.value))}
                          onClick={(e) => e.stopPropagation()}
                          className="flex-1 bg-[#5A8352] border-[2px] border-[#E8E8D8]/20 text-[#E8E8D8] text-[7px] p-1 font-bold"
                        >
                          <option value={2}>GOES TO TEAM 2</option>
                          <option value={3}>GOES TO TEAM 3</option>
                        </select>
                      </div>
                    </div>
                  )}
            ...
            {/* Selection Summary */}
            <div className="mt-3 pt-3 border-t-[3px] border-[#4A6844]">
              <div className="text-[8px] text-[#E8E8D8] font-bold mb-1">
                TRADING: {team1Selected.length} player{team1Selected.length !== 1 ? "s" : ""}
              </div>
              <div className="text-[9px] text-[#E8E8D8] font-bold mt-2">
                TOTAL: ${team1Total.toFixed(1)}M
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#5A8352] border-[4px] border-[#4A6844] p-3">
            <div className="mb-3">
              <label className="text-[8px] text-[#E8E8D8] font-bold mb-1 block">TEAM 2</label>
              <select
                value={team2}
                onChange={(e) => {
              ...
              {getRoster(team2).map(player => (
                <div key={player.id}>
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <div className={`text-[9px] font-bold ${team2Selected.includes(player.id) ? "text-[#000000]" : "text-[#E8E8D8]"}`}>{player.name}</div>
                        <div className={`text-[7px] ${team2Selected.includes(player.id) ? "text-[#000000]/70" : "text-[#E8E8D8]/70"}`}>{player.pos} • OVR {player.ovr}</div>
                      </div>
                      <div className={`text-[8px] font-bold ${team2Selected.includes(player.id) ? "text-[#000000]" : "text-[#E8E8D8]"}`}>{player.salary}</div>
                    </div>
                  </div>
                  {/* Destination selector for three-way trades */}
                  {tradeMode === "three-way" && team2Selected.includes(player.id) && (
                    <div className="mt-1 bg-[#4A6844] border-[2px] border-[#E8E8D8]/30 p-1.5">
                      <div className="flex items-center gap-2">
                        <ArrowRight className="w-3 h-3 text-[#E8E8D8]" />
                        <select
                          value={team2Destinations[player.id] || 1}
                          onChange={(e) => setPlayerDestination(2, player.id, parseInt(e.target.value))}
                          onClick={(e) => e.stopPropagation()}
                          className="flex-1 bg-[#5A8352] border-[2px] border-[#E8E8D8]/20 text-[#E8E8D8] text-[7px] p-1 font-bold"
                        >
                          <option value={1}>GOES TO TEAM 1</option>
                          <option value={3}>GOES TO TEAM 3</option>
                        </select>
                      </div>
                    </div>
            ...
            <div className="mt-3 pt-3 border-t-[3px] border-[#4A6844]">
              <div className="text-[8px] text-[#E8E8D8] font-bold mb-1">
                TRADING: {team2Selected.length} player{team2Selected.length !== 1 ? "s" : ""}
              </div>
              <div className="text-[9px] text-[#E8E8D8] font-bold mt-2">
                TOTAL: ${team2Total.toFixed(1)}M
              </div>
            </div>
          </div>

          {/* Team 3 Column (only in three-way mode) */}
          {tradeMode === "three-way" && (
            <div className="bg-[#5A8352] border-[4px] border-[#4A6844] p-3">
              <div className="mb-3">
                <label className="text-[8px] text-[#E8E8D8] font-bold mb-1 block">TEAM 3</label>
                <select
                  value={team3}
                  onChange={(e) => {
              ...
              {/* Roster */}
              <div className="space-y-1 max-h-[400px] overflow-y-auto">
                {getRoster(team3).map(player => (
                  <div key={player.id}>
                    <div
                      className={`p-2 border-[3px] cursor-pointer transition ${
                        team3Selected.includes(player.id)
                          ? "bg-[#FFD700] border-[#000000]"
                          : "bg-[#4A6844] border-[#5A8352] hover:border-[#E8E8D8]/50"
                      }`}
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <div className={`text-[9px] font-bold ${team3Selected.includes(player.id) ? "text-[#000000]" : "text-[#E8E8D8]"}`}>{player.name}</div>
                          <div className={`text-[7px] ${team3Selected.includes(player.id) ? "text-[#000000]/70" : "text-[#E8E8D8]/70"}`}>{player.pos} • OVR {player.ovr}</div>
                        </div>
                        <div className={`text-[8px] font-bold ${team3Selected.includes(player.id) ? "text-[#000000]" : "text-[#E8E8D8]"}`}>{player.salary}</div>
                      </div>
                    </div>
                    {/* Destination selector for three-way trades */}
                    {tradeMode === "three-way" && team3Selected.includes(player.id) && (
                      <div className="mt-1 bg-[#4A6844] border-[2px] border-[#E8E8D8]/30 p-1.5">
                        <div className="flex items-center gap-2">
                          <ArrowRight className="w-3 h-3 text-[#E8E8D8]" />
                          <select
                            value={team3Destinations[player.id] || 1}
                            onChange={(e) => setPlayerDestination(3, player.id, parseInt(e.target.value))}
                            onClick={(e) => e.stopPropagation()}
                            className="flex-1 bg-[#5A8352] border-[2px] border-[#E8E8D8]/20 text-[#E8E8D8] text-[7px] p-1 font-bold"
                          >
                            <option value={1}>GOES TO TEAM 1</option>
              ...
              <div className="mt-3 pt-3 border-t-[3px] border-[#4A6844]">
                <div className="text-[8px] text-[#E8E8D8] font-bold mb-1">
                  TRADING: {team3Selected.length} player{team3Selected.length !== 1 ? "s" : ""}
                </div>
                <div className="text-[9px] text-[#E8E8D8] font-bold mt-2">
                  TOTAL: ${team3Total.toFixed(1)}M
                </div>
              </div>
            </div>
          )}
        ...
        {/* Salary Net Difference */}
        {(team1Selected.length > 0 || team2Selected.length > 0 || (tradeMode === "three-way" && team3Selected.length > 0)) && (
          <div className="mt-4 bg-[#4A6844] border-[4px] border-[#E8E8D8] p-3">
            <div className="text-center">
              <div className="text-[8px] text-[#E8E8D8]/70 mb-1">SALARY COMPARISON</div>
              <div className="text-[10px] text-[#E8E8D8] font-bold">
                {getNetDifference()}
              </div>
            </div>
          </div>
          ...
          {!tradeProposed ? (
            <>
              <button
                ...
                disabled={team1Selected.length === 0 || team2Selected.length === 0}
                className="flex-1 py-3 px-4 bg-[#0066FF] border-[4px] border-[#003388] text-[#E8E8D8] font-bold text-[10px] disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#0055DD] transition"
              >
              ...
              <button
                onClick={cancelTrade}
                className="py-3 px-4 bg-[#DD0000] border-[4px] border-[#880000] text-[#E8E8D8] font-bold text-[10px] hover:bg-[#BB0000] transition"
              >
                CLEAR
              </button>
            </>
            ...
            <>
              <button
                onClick={acceptTrade}
                className="flex-1 py-3 px-4 bg-[#4A6844] border-[4px] border-[#E8E8D8] text-[#E8E8D8] font-bold text-[10px] hover:bg-[#5A8352] transition"
              >
        ...
        {/* Trade Proposed Banner */}
        {tradeProposed && (
          <div className="mt-4 bg-[#7733DD] border-[4px] border-[#E8E8D8] p-3 text-center">
            <div className="text-[10px] text-[#E8E8D8] font-bold">TRADE PROPOSAL READY FOR REVIEW</div>
            <div className="text-[8px] text-[#E8E8D8]/80 mt-1">Review the selected players and accept or reject the trade</div>
          </div>
        )}
      </div>
      ...
      {selectedPlayerCard && (
        ...
        >
          <div
            className="bg-[#6B9462] border-[6px] border-[#4A6844] p-6 max-w-md w-full mx-4"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="text-center mb-4 pb-4 border-b-[4px] border-[#4A6844]">
              <div className="text-[14px] text-[#E8E8D8] font-bold mb-1">{selectedPlayerCard.name}</div>
              <div className="text-[10px] text-[#E8E8D8]/70">{selectedPlayerCard.pos}</div>
              <div className="text-[16px] text-[#E8E8D8] font-bold mt-2">OVR {selectedPlayerCard.ovr}</div>
              <div className="text-[12px] text-[#E8E8D8] mt-1">{selectedPlayerCard.salary}</div>
            </div>

            {/* Attributes */}
            <div className="space-y-2">
              {selectedPlayerCard.con !== undefined && (
                <>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">CONTACT</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.con}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">POWER</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.pow}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">SPEED</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.spd}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">FIELDING</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.fld}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">ARM</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.arm}</span>
                  </div>
                </>
              )}
              {selectedPlayerCard.vel !== undefined && (
                <>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">VELOCITY</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.vel}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">JUNK</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.junk}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">ACCURACY</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.acc}</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#5A8352] border-[3px] border-[#4A6844] p-2">
                    <span className="text-[9px] text-[#E8E8D8] font-bold">STAMINA</span>
                    <span className="text-[10px] text-[#E8E8D8] font-bold">{selectedPlayerCard.stamina}</span>
                  </div>
                </>
              )}
            </div>
            ...
            <button
              onClick={() => setSelectedPlayerCard(null)}
              className="w-full mt-4 py-2 px-4 bg-[#4A6844] border-[4px] border-[#E8E8D8] text-[#E8E8D8] font-bold text-[10px] hover:bg-[#5A8352] transition"
            >
              CLOSE
            </button>
          </div>
      ...
      <div className="bg-[#6B9462] border-[5px] border-[#4A6844] p-3">
        <div className="text-[8px] text-[#E8E8D8]/70 text-center">
          Click to select players • Double-click to view player card • Selected players are highlighted in purple
        </div>
      </div>
    </div>
  );
...
function AwardsContent() {
  ...
  const boogerGloveWinnerAL = { position: "2B", player: "T. Clumsy", team: "Sox", tier: "BOOGER", fWAR: "-1.2" };

  // Mock award winners - NL
  const goldGloveWinnersNL = [
    { position: "C", player: "D. Lee", team: "Beewolves", tier: "GOLD", fWAR: "5.8" },
    { position: "1B", player: "R. Williams", team: "Nemesis", tier: "PLATINUM", fWAR: "6.5" },
    { position: "2B", player: "J. Martinez", team: "Moonstars", tier: "GOLD", fWAR: "5.1" },
    { position: "3B", player: "D. Wilson", team: "Beewolves", tier: "GOLD", fWAR: "5.5" },
  ...
  const boogerGloveWinnerNL = { position: "LF", player: "B. Butterfingers", team: "Moonstars", tier: "BOOGER", fWAR: "-1.5" };

  const silverSluggersAL = [
    { position: "C", player: "M. Santos", team: "Sox" },
    { position: "1B", player: "M. Thompson", team: "Crocs" },
    { position: "2B", player: "K. Martinez", team: "Sox" },
    { position: "3B", player: "J. Rodriguez", team: "Tigers" },
  ...
  return (
    <div className="space-y-4 max-h-[calc(100vh-300px)] overflow-y-auto">
      {/* Season 1 Awards Header */}
      <div className="bg-[#5599FF] border-[6px] border-black p-4 text-center">
        <div className="text-2xl text-black mb-1" style={{ textShadow: '2px 2px 0px rgba(0,0,0,0.2)' }}>
          SEASON 1 AWARDS CEREMONY
        </div>
        <div className="text-[8px] text-black/70">CELEBRATING EXCELLENCE</div>
      </div>
      ...
      <div>
        <button
          onClick={() => toggleSection("leaders")}
          className="w-full bg-white border-[5px] border-black py-3 px-4 text-[10px] text-black hover:bg-[#F0F0F0] active:scale-[0.99] transition-transform shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)] flex items-center justify-between"
        >
          <span>▶ LEAGUE LEADERS</span>
          {expandedSection === "leaders" ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
        </button>
        ...
        {expandedSection === "leaders" && (
          <div className="bg-white border-[5px] border-black border-t-0 p-4">
            {/* League toggles */}
            <div className="flex gap-2 mb-4">
              <button
                onClick={() => setExpandedLeague("al")}
                className={`flex-1 py-2 px-4 border-[4px] border-black transition ${
                  expandedLeague === "al" ? "bg-[#0066FF] text-white" : "bg-[#D0D0D0] text-black hover:bg-[#E0E0E0]"
                }`}
              >
                <div className="text-[10px] font-bold">AMERICAN LEAGUE</div>
              </button>
              <button
                onClick={() => setExpandedLeague("nl")}
                className={`flex-1 py-2 px-4 border-[4px] border-black transition ${
                  expandedLeague === "nl" ? "bg-[#DD0000] text-white" : "bg-[#D0D0D0] text-black hover:bg-[#E0E0E0]"
                }`}
              >
                <div className="text-[10px] font-bold">NATIONAL LEAGUE</div>
              </button>
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Batting Leaders */}
              <div>
                <div className={`border-[4px] border-black p-2 mb-2 ${expandedLeague === "al" ? "bg-[#0066FF]" : "bg-[#DD0000]"}`}>
                  <div className="text-[8px] text-white text-center">BATTING LEADERS</div>
                </div>
                <div className="space-y-1">
                  {(expandedLeague === "al" ? battingLeadersAL : battingLeadersNL).map((leader, index) => {
                    const battingData = expandedLeague === "al" ? battingLeadersDataAL : battingLeadersDataNL;
                    return (
                      <div key={index}>
                        <button
                          onClick={() => setExpandedBattingStat(expandedBattingStat === leader.stat ? null : leader.stat)}
                          className="w-full bg-[#D0D0D0] border-[3px] border-black p-2 hover:bg-[#E0E0E0] transition"
                        >
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-2">
                              <div className="text-[8px] text-black font-bold">{leader.stat}</div>
                              {expandedBattingStat === leader.stat ? (
                            ...
                            <div className="text-[10px] text-[#DD0000] font-bold">{leader.value}</div>
                          </div>
                          <div className="text-[8px] text-black/70 text-left">
                        ...
                        {expandedBattingStat === leader.stat && (
                          <div className="bg-white border-[3px] border-black border-t-0 p-2">
                            <div className="text-[7px] text-[#0066FF] font-bold mb-1">TOP 5</div>
                            {battingData[leader.stat as keyof typeof battingData].map((player, pIndex) => (
                              <div 
                                key={pIndex} 
                              ...
                              >
                                ...
                                <div className="text-[8px] text-[#DD0000] font-bold">{player.value}</div>
                              </div>
                            ))}
                          </div>
                        )}
              ...
              <div>
                <div className={`border-[4px] border-black p-2 mb-2 ${expandedLeague === "al" ? "bg-[#0066FF]" : "bg-[#DD0000]"}`}>
                  <div className="text-[8px] text-white text-center">PITCHING LEADERS</div>
                </div>
                <div className="space-y-1">
                  {(expandedLeague === "al" ? pitchingLeadersAL : pitchingLeadersNL).map((leader, index) => {
                    const pitchingData = expandedLeague === "al" ? pitchingLeadersDataAL : pitchingLeadersDataNL;
                    return (
                      <div key={index}>
                        ...
                        {expandedPitchingStat === leader.stat && (
                          <div className="bg-white border-[3px] border-black border-t-0 p-2">
                            <div className={`text-[7px] font-bold mb-1 ${expandedLeague === "al" ? "text-[#0066FF]" : "text-[#DD0000]"}`}>TOP 5</div>
                            {pitchingData[leader.stat as keyof typeof pitchingData].map((player, pIndex) => (
                              <div 
                                key={pIndex} 
                                className="flex justify-between items-center py-1 border-b border-gray-300 last:border-b-0"
      ...
      <div>
        <button
          onClick={() => toggleSection("gloves")}
          className="w-full bg-[#FFD700] border-[5px] border-black py-3 px-4 text-[10px] text-black hover:bg-[#FFDF33] active:scale-[0.99] transition-transform shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)] flex items-center justify-between"
        >
          <span>▶ GOLD / PLATINUM / BOOGER GLOVES</span>
          {expandedSection === "gloves" ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
        </button>
        ...
        {expandedSection === "gloves" && (
          <div className="bg-white border-[5px] border-black border-t-0 p-4">
            ...
            {/* Display selected league */}
            <div className="grid grid-cols-3 gap-2">
              {(expandedLeague === "al" ? goldGloveWinnersAL : goldGloveWinnersNL).map((winner, index) => (
                <div 
                  key={index} 
                  className="border-[4px] border-black p-3"
                  style={{ backgroundColor: getTierColor(winner.tier) }}
                >
                  <div className="text-center">
                    <div className="text-sm text-black font-bold mb-1">{winner.position}</div>
                    <div className="text-[8px] text-black">{winner.player}</div>
                    <div className="text-[8px] text-black/70">{winner.team}</div>
                    <div className="mt-2 text-[7px] text-black font-bold">{winner.tier}</div>
                    <div className="text-[7px] text-black/70">fWAR: {winner.fWAR}</div>
                  </div>
                </div>
              ))}
              <div 
                className="border-[4px] border-black p-3"
                style={{ backgroundColor: getTierColor(expandedLeague === "al" ? boogerGloveWinnerAL.tier : boogerGloveWinnerNL.tier) }}
              >
                <div className="text-center">
                  <div className="text-sm text-black font-bold mb-1">{expandedLeague === "al" ? boogerGloveWinnerAL.position : boogerGloveWinnerNL.position}</div>
                  <div className="text-[8px] text-black">{expandedLeague === "al" ? boogerGloveWinnerAL.player : boogerGloveWinnerNL.player}</div>
                  <div className="text-[8px] text-black/70">{expandedLeague === "al" ? boogerGloveWinnerAL.team : boogerGloveWinnerNL.team}</div>
                  <div className="mt-2 text-[7px] text-black font-bold">{expandedLeague === "al" ? boogerGloveWinnerAL.tier : boogerGloveWinnerNL.tier}</div>
                  <div className="text-[7px] text-black/70">fWAR: {expandedLeague === "al" ? boogerGloveWinnerAL.fWAR : boogerGloveWinnerNL.fWAR}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        {expandedSection === "sluggers" && (
          <div className="bg-white border-[5px] border-black border-t-0 p-4">
            ...
            {/* Display selected league */}
            <div className="grid grid-cols-3 gap-2">
              {(expandedLeague === "al" ? silverSluggersAL : silverSluggersNL).map((winner, index) => (
                <div key={index} className="bg-[#C0C0C0] border-[4px] border-black p-3">
                  <div className="text-center">
                    <div className="text-sm text-black font-bold mb-1">{winner.position}</div>
                    <div className="text-[8px] text-black">{winner.player}</div>
                    <div className="text-[8px] text-black/70">{winner.team}</div>
      ...
      <div>
        ...
        {expandedSection === "major" && (
          <div className="bg-white border-[5px] border-black border-t-0 p-4">
            ...
            {/* Display selected league */}
            <div className="space-y-2">
              {(expandedLeague === "al" ? majorAwardsAL : majorAwardsNL).map((award, index) => (
                <div key={index} className="bg-[#D0D0D0] border-[4px] border-black p-3">
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="text-[10px] text-black font-bold mb-1">{award.award}</div>
                      <div className={`text-[8px] ${expandedLeague === "al" ? "text-[#0066FF]" : "text-[#DD0000]"}`}>{award.player} ({award.team})</div>
                      <div className="text-[8px] text-black/70 mt-1">{award.stats}</div>
                    </div>
                    <Trophy className="w-6 h-6 text-[#FFD700]" />
                  </div>
                </div>
            ...
            {/* League-Wide Awards */}
            <div className="mt-6">
              <div className="bg-[#7733DD] border-[4px] border-black p-2 mb-3">
                <div className="text-[10px] text-white text-center font-bold">LEAGUE-WIDE AWARDS</div>
              </div>
              <div className="space-y-2">
                {leagueWideAwards.map((award, index) => (
                  <div key={index} className="bg-[#D0D0D0] border-[4px] border-black p-3">
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="text-[10px] text-black font-bold mb-1">{award.award}</div>
                        <div className="text-[8px] text-[#7733DD]">{award.player} ({award.team})</div>
                        <div className="text-[8px] text-black/70 mt-1">{award.stats}</div>
                      </div>
                      <Trophy className="w-6 h-6 text-[#FFD700]" />
                    </div>
      ...
      {/* Trait Assignments Wheel Section */}
      <div>
        <button
          onClick={() => toggleSection("traits")}
          className="w-full bg-[#5599FF] border-[5px] border-black py-3 px-4 text-[10px] text-white hover:bg-[#66AAFF] active:scale-[0.99] transition-transform shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)] flex items-center justify-between"
        >
          <span>▶ TRAIT ASSIGNMENTS (WHEEL SPIN)</span>
          {expandedSection === "traits" ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
        </button>
        ...
        {expandedSection === "traits" && (
          <div className="bg-white border-[5px] border-black border-t-0 p-4">
            <div className="grid grid-cols-2 gap-4">
              {/* Player Selection */}
              <div>
                <div className="bg-[#0066FF] border-[4px] border-black p-2 mb-3">
                  <div className="text-[8px] text-white text-center">SELECT PLAYER</div>
                </div>
                <div className="space-y-2">
                  {playersForTraits.map((player, index) => (
                    <button
                      key={index}
                      onClick={() => setSelectedPlayer(player)}
                      className={`w-full border-[4px] border-black p-2 text-[8px] transition ${
                        selectedPlayer === player
                          ? "bg-[#FFD700] text-black"
                          : "bg-[#D0D0D0] text-black hover:bg-[#E0E0E0]"
                      }`}
                    >
                      {player}
                    </button>
                ...
                <button
                  ...
                  className={`w-full mt-4 border-[5px] border-black py-3 text-[10px] text-white transition-transform shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)] ${
                    spinning || !selectedPlayer
                      ? "bg-[#808080] cursor-not-allowed"
                      : "bg-[#DD0000] hover:bg-[#EE1111] active:scale-95"
                  }`}
                >
              ...
              <div className="flex items-center justify-center">
                <div className="relative">
                  {/* Wheel */}
                  <div
                    className="w-64 h-64 rounded-full border-[8px] border-black relative overflow-hidden"
                    style={{
                  ...
                  >
                    {traits.map((trait, index) => {
                      ...
                      const colors = ["#DD0000", "#0066FF", "#7733DD", "#CC44CC", "#5599FF", "#3366FF", "#FF0066", "#0099FF"];
                      return (
                        <div
                          key={index}
                        ...
                        >
                          <div
                            ...
                            style={{
                              ...
                              borderTop: `128px solid ${colors[index]}`,
                              transform: "translateX(-50%)",
                            }}
                          />
                          <div
                            className="absolute top-8 left-1/2 -translate-x-1/2 text-[7px] text-white font-bold whitespace-nowrap"
                            style={{
                  ...
                  {/* Center circle */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white border-[6px] border-black rounded-full flex items-center justify-center">
            ...
            <div className="mt-4 text-center text-[8px] text-black/70">
              SELECT A PLAYER AND SPIN THE WHEEL TO ASSIGN A RANDOM TRAIT
            </div>
          </div>
        )}
      </div>
