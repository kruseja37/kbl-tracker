...
const PRE_REBALANCE_NON_CHEMISTRY_GOLDEN = [
  {
    ...
    trueGrade: 'B',
    potentialGrade: 'B+',
    ratings: { power: 20, contact: 37, speed: 32, fielding: 34, arm: 43, velocity: 51, junk: 64, accuracy: 58 },
    arsenal: ['CF', 'SB', '4F', 'FK'],
    trait1: 'K Collector',
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'B',
    ratings: { power: 58, contact: 52, speed: 38, fielding: 50, arm: 61, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    personality: 'Timid',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'B-',
    ratings: { power: 45, contact: 65, speed: 53, fielding: 33, arm: 43, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
  ...
  },
  {
    ...
    trueGrade: 'B-',
    potentialGrade: 'B+',
    ratings: { power: 43, contact: 72, speed: 59, fielding: 60, arm: 49, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    trait1: 'POW vs RHP',
    personality: 'Egotistical',
