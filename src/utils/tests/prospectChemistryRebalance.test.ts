...
// Golden re-pinned 2026-07-08: WT-B (a4de48c7) replaced the uniform personality draw with the
// JK-ruled weighted draw (Droopy/Timid 0.10, others 0.16). Programmatic diff vs the prior pin
// confirmed ONLY the personality field changed across all 8 candidates (stateless per-seed
// hashing isolates draws), so the no-perturbation invariant this golden guards is intact.
