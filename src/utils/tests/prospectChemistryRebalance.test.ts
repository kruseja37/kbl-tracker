...
const PRE_REBALANCE_NON_CHEMISTRY_GOLDEN = [
  {
    ...
    trueGrade: 'B',
    potentialGrade: 'B+',
    ratings: { power: 20, contact: 34, speed: 29, fielding: 34, arm: 39, velocity: 42, junk: 64, accuracy: 70 },
    arsenal: ['CF', 'SB', '4F', 'FK'],
    trait1: 'Metal Head',
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'A-',
    potentialGrade: 'A-',
    ratings: { power: 44, contact: 47, speed: 60, fielding: 64, arm: 66, velocity: 57, junk: 66, accuracy: 81 },
    arsenal: ['2F', 'FK', '4F', 'CH'],
    trait1: 'Composed',
    personality: 'Relaxed',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'C+',
    ratings: { power: 69, contact: 45, speed: 40, fielding: 35, arm: 49, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    trait1: 'Base Rounder',
    trait2: 'Bunter',
    personality: 'Relaxed',
  ...
  },
  {
    ...
    trueGrade: 'D',
    potentialGrade: 'D',
    ratings: { power: 25, contact: 34, speed: 38, fielding: 49, arm: 38, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'B',
    ratings: { power: 68, contact: 47, speed: 33, fielding: 45, arm: 61, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    personality: 'Timid',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'B-',
    ratings: { power: 37, contact: 64, speed: 54, fielding: 51, arm: 47, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    trait1: 'Base Rounder',
    trait2: 'Big Hack',
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'B-',
    potentialGrade: 'B+',
    ratings: { power: 38, contact: 70, speed: 61, fielding: 74, arm: 52, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
