...
const PRE_REBALANCE_NON_CHEMISTRY_GOLDEN = [
  {
    ...
    trueGrade: 'C',
    potentialGrade: 'C+',
    ratings: { power: 20, contact: 20, speed: 20, fielding: 20, arm: 25, velocity: 29, junk: 50, accuracy: 54 },
    arsenal: ['CF', 'SB', '4F', 'FK'],
    trait1: 'BB Prone',
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'B+',
    potentialGrade: 'B+',
    ratings: { power: 38, contact: 40, speed: 54, fielding: 57, arm: 59, velocity: 50, junk: 60, accuracy: 77 },
    arsenal: ['2F', 'FK', '4F', 'CH'],
    trait1: 'Composed',
    personality: 'Relaxed',
  ...
  },
  {
    ...
    trueGrade: 'D',
    potentialGrade: 'D',
    ratings: { power: 48, contact: 29, speed: 24, fielding: 20, arm: 31, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    trait1: 'Base Rounder',
    trait2: 'Bunter',
    personality: 'Relaxed',
  ...
  },
  {
    ...
    trueGrade: 'C',
    potentialGrade: 'C',
    ratings: { power: 38, contact: 46, speed: 49, fielding: 60, arm: 49, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'B',
    potentialGrade: 'A-',
    ratings: { power: 79, contact: 57, speed: 43, fielding: 55, arm: 71, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    personality: 'Timid',
  ...
  },
  {
    ...
    trueGrade: 'C-',
    potentialGrade: 'C',
    ratings: { power: 27, contact: 53, speed: 43, fielding: 36, arm: 35, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    trait1: 'Base Rounder',
    trait2: 'Big Hack',
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'B-',
    potentialGrade: 'B-',
    ratings: { power: 20, contact: 25, speed: 28, fielding: 38, arm: 53, velocity: 48, junk: 40, accuracy: 72 },
    arsenal: ['4F', 'CB', 'CF', '2F'],
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'B',
    ratings: { power: 32, contact: 65, speed: 56, fielding: 69, arm: 47, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
