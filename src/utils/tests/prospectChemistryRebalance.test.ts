...
const PRE_REBALANCE_NON_CHEMISTRY_GOLDEN = [
  {
    ...
    trueGrade: 'B',
    potentialGrade: 'B+',
    ratings: { power: 20, contact: 32, speed: 28, fielding: 33, arm: 38, velocity: 41, junk: 63, accuracy: 69 },
    arsenal: ['CF', 'SB', '4F', 'FK'],
    trait1: 'K Collector',
    personality: 'Jolly',
  ...
  },
  {
    ...
    trueGrade: 'A-',
    potentialGrade: 'A-',
    ratings: { power: 45, contact: 47, speed: 61, fielding: 64, arm: 66, velocity: 58, junk: 66, accuracy: 82 },
    arsenal: ['2F', 'FK', '4F', 'CH'],
    trait1: 'Elite 2F',
    personality: 'Relaxed',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'C+',
    ratings: { power: 69, contact: 45, speed: 41, fielding: 35, arm: 49, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
    trait1: 'Base Rounder',
    trait2: 'Big Hack',
    personality: 'Relaxed',
  ...
  },
  {
    ...
    trueGrade: 'C+',
    potentialGrade: 'B-',
    ratings: { power: 37, contact: 64, speed: 55, fielding: 51, arm: 48, velocity: 0, junk: 0, accuracy: 0 },
    arsenal: [],
