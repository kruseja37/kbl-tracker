...
const trackerStores: Record<string, StoreSchema> = {
  ...
  franchiseRatingsOverlays: {
    ...
    indexes: [
      { name: 'by_scope', keyPath: ['franchiseId', 'seasonId', 'statsScopeId'] },
      { name: 'by_player', keyPath: ['franchiseId', 'seasonId', 'statsScopeId', 'playerId'] },
    ],
    optional: true,
  },
  franchiseRelationshipEdges: {
    ...
    indexes: [
      { name: 'by_scope', keyPath: ['franchiseId', 'seasonId', 'statsScopeId'] },
      { name: 'by_pair', keyPath: ['player1Id', 'player2Id'] },
    ],
    optional: true,
  },
  franchiseL10Overlays: {
    ...
    indexes: [
      { name: 'by_scope', keyPath: ['franchiseId', 'seasonId', 'statsScopeId'] },
      { name: 'by_target', keyPath: ['franchiseId', 'seasonId', 'statsScopeId', 'targetId'] },
    ],
    optional: true,
  },
