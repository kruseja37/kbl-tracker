...
| 5e | MODE-KILL-1: three-mode fail-closed per `MODE_TRUTH_SWEEP_2026-07-11.md` kill list — headline: mode-AWARE startup recovery (AppHome/useDataIntegrity live leak); allow-list shouldAggregate; no season-1 defaults in writers; blocking identity validation; exhibition stops fabricating season-N; stacked AFTER KERNEL2 (same file) | ⏳ | QUEUED (sweep DONE) |
