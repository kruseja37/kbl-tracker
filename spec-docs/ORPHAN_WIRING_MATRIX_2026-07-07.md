...
5. **Manager of the Year weight (50/50 deployment-WPA vs. record) is an admitted placeholder** — needs a §16 tuning decision on the real split. **TRACKED 2026-07-07 — PENDING-JK-CONFIRM row added to `V1_CANON_2026-07-07.md` §6.** [MGR]
6. **The 52/59 dead Master Morale Matrix rows** — purge now (cleaner, less confusing for tuning) or leave as scaffolding for a later wave (WIN/LOSS/CHAMPIONSHIP/CLUTCH_HIT/MANAGER_FIRED/etc.)? Recommendation: purge — a §16 tuner should not be able to "tune" a row that can never fire. **TRACKED 2026-07-07 — PENDING-JK-CONFIRM row added to `V1_CANON_2026-07-07.md` §6; a wire-now/defer/kill triage doc is expected before this closes.** [PM, CRITIC]
