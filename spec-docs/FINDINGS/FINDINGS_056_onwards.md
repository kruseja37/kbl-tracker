...
### FINDING-135
**Date:** 2026-06-12 | **Phase:** W1 arc (WAR persistence) | **Status:** CONFIRMED — DEFERRED to FINDING-134 discovery slot
**File:** src/utils/franchiseInitializer.ts (deriveSeasonTotalGames, ~:331)
...
**F-138 SCOPE ADDENDUM (2026-06-12, Captain spot-check during F134-T4/F135-T2 arc):** RetirementFlow.tsx (:567) is a FOURTH flag-gated consumer of useOffseasonData (stock playerDatabase) — F-138's flow count is four, not three (FinalizeAdvance, Awards, FreeAgency, Retirement). RetirementFlow carries zero $M-scale sites (swept 2026-06-12; its convertToLocalPlayer does not multiply) — denomination-clean, but included in the post-D0 franchise-data-source ticket scope.
