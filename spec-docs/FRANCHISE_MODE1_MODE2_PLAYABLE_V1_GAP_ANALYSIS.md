...
| Visual smoke needs seeded repeatability | Current browser smoke cannot reliably reach Team Hub/live GameTracker in a fresh IndexedDB context | Manual smoke feedback; release confidence | Browser smoke covered reachable surfaces, but fresh context lacks prepared League Builder/FARM/scouting state | Provide or document a seeded smoke harness/fixture state for Team Hub and GameTracker screenshots | P0 Release Confidence | Seeded Visual Smoke Harness For Team Hub And GameTracker | Deterministic setup, no user-data dependency, screenshots at iPad and desktop widths | No auto-draft unless separately approved as tooling |
