...
**➡ NEXT (this session): S6 (Branch B, draft-board UI — fan-out per JK) ∥ A1.5c-3 (extraBases, Branch A, pure build-dark). Then RA-8 (A2.2, pulled forward per JK) → A1.5c-4 (catcher-CS). A1.5d stadium records still gated on A1.5a+A1.5b+WPA archive.**
