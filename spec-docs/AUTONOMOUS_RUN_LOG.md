...
**➡ NEXT: MAIN = DT-F (bespoke traits incl. Metal-Head=PITCHER protective — the LAST DT-x); Lane C = RA-9b (sweep recent-window aggregation) then PARK→WAR (V8) seed wiring → other ratings-finish.**
