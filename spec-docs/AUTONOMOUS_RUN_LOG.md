...
**➡ NEXT (this session, parallel): dispatch A1.5c-2 (UBR, Branch A, build+affected-test) + S6 (Branch B, full-suite gate) — serialized heavy suites. Then A1.5c-3 (extraBases) → RA-8 (A2.2) → A1.5c-4. A1.5d stadium records still gated on A1.5a+A1.5b+WPA archive.**
