...
> **➡ START HERE (Branch A): RA-2c-2 — LIVE-wire the checkpoint sweep with the REFINED model (full ruling: DECISIONS_LOG 2026-06-24 "RA-2 ratings-adjustment — peer-pool, eligibility & signal model"; display-dark behind the triple gate, SMB4-asset gate APPROVED). RA-2c-1a ✅ DONE this session — RA-2c-2 is the SOLE remaining RA-2c step:**
