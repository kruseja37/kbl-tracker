...
| Missing | The new-line economy work (portable: 7 cherry-picks + 2 test unions [agent-✓ port map, spot-checked]) | ~1,194 commits of v1 [git]: soul, freeze options, score-only, awards, All-Star, L-SIM, the SOT docs; ships a SIMULATE path the v1 spec removed [read: MODE_2 §22.3 verified by grep] |
...
1. Trunk's full-suite baseline today (re-proven in Phase 1's gate).
