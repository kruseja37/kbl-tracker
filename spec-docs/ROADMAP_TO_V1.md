> ⚠️ **SUPERSEDED (2026-07-01).** The single v1 source of truth is **`spec-docs/V1_BUILD_STATUS.md`**. This doc's status, branch-map, and scope claims are stale (pre the 2026-06-30 draft re-design + 24-archetype lock, and pre the 2026-07-01 assembly reality). Kept for history — do not plan from it.
