...
Next roadmap steps are formula weighting, stadium context, relationship context, and season-level morale rollups once canonical value/designation inputs are trusted.
