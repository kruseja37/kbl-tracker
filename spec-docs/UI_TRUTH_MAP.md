...
| 13 | `/franchise/setup` | FranchiseSetup | "NEW FRANCHISE" 6-step wizard (League/Season/Playoffs/Teams/Rosters/Confirm); seeded MLB/SML league templates appear. | **OLD-DIALECT** — PS2P headers, hardcoded bright green rgb(107,148,98) | KEEP/reskin | **KEEP + RESKIN** (tokenize hexes, help-gate explainers) | 0 | route-13 |
...
| 34 | `/league-builder/rules` | LeagueBuilderRules | "RULES PRESETS": 3 presets (Full Simulation/Quick Play/Standard) + GAME/SEASON/PLAYOFFS tabs w/ editable rules. | **OLD-DIALECT** (league-builder family; JK ruled RULES = LEAVE ALONE) | KEEP/reskin | **KEEP** (JK ruling: leave alone) | 0 | route-34 |
