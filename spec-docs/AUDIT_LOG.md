...
| FINDING-104 | Trait System — catalog exists (60+ traits), player fields exist, zero execution layer | STUB — Trait interface missing chemistryType/trigger/effect fields; no potency calc; no trigger engine; traitPools.ts never imported; 7 vs 5 chemistry type mismatch; traits misused as personality proxy |
