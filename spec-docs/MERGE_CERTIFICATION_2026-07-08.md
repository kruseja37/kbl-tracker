...
| R6 | D3K error-cause + fielder-position tracking — real scoring-granularity gap, but branch is 5 months stale vs main's rewritten D3K flow | `codex/d3k-fix` | — | **RULED OUT OF V1 (JK, 2026-07-08): covered by the GameTracker branch freeze — deferred post-v1** |
