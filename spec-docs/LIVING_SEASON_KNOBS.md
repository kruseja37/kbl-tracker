...
| `RELATIONSHIP_FORMATION_TUNING.perGameHazard.potentialBase` | 0.03 | `src/engines/relationshipFormation.ts` | Base per-game chance at the bottom of the seeded potential window | R-F organic per-game formation ruling (2026-07-11) | LIVE-BEHIND-L13-FLAG |
| `RELATIONSHIP_FORMATION_TUNING.perGameHazard.potentialSlopePerPoint` | 2.0 | `src/engines/relationshipFormation.ts` | Adds hazard across the below-threshold potential window | R-F organic per-game formation ruling (2026-07-11) | LIVE-BEHIND-L13-FLAG |
| `RELATIONSHIP_FORMATION_TUNING.perGameHazard.potentialCap` | 0.15 | `src/engines/relationshipFormation.ts` | Caps potential-window formation chance on any one completed game | R-F organic per-game formation ruling (2026-07-11) | LIVE-BEHIND-L13-FLAG |
