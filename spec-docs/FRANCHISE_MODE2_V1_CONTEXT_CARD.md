...
- Awards/watchlists are explicitly blocked by the 1.9 audit until a Final WAR / Award Trust Promotion Gate proves final award-consumer WAR trust, award-specific True Value/value-delta policy, milestone weighting, adaptive thresholds, score-only exclusion, and hidden FARM exclusion.
